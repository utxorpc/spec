...
impl serde::Serialize for AnyChainBlock {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("utxorpc.v1.sync.AnyChainBlock", len)?;
...
impl<'de> serde::Deserialize<'de> for AnyChainBlock {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct utxorpc.v1.sync.AnyChainBlock")
            }
...
;
        ...
        deserializer.deserialize_struct("utxorpc.v1.sync.AnyChainBlock", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for BlockRef {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("utxorpc.v1.sync.BlockRef", len)?;
        if self.index != 0 {
...
impl<'de> serde::Deserialize<'de> for BlockRef {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct utxorpc.v1.sync.BlockRef")
            }
        ...
        deserializer.deserialize_struct("utxorpc.v1.sync.BlockRef", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for DumpHistoryRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("utxorpc.v1.sync.DumpHistoryRequest", len)?;
...
impl<'de> serde::Deserialize<'de> for DumpHistoryRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct utxorpc.v1.sync.DumpHistoryRequest")
            }
        ...
        deserializer.deserialize_struct("utxorpc.v1.sync.DumpHistoryRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for DumpHistoryResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("utxorpc.v1.sync.DumpHistoryResponse", len)?;
        if !self.block.is_empty() {
...
impl<'de> serde::Deserialize<'de> for DumpHistoryResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct utxorpc.v1.sync.DumpHistoryResponse")
            }
        ...
        deserializer.deserialize_struct("utxorpc.v1.sync.DumpHistoryResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for FetchBlockRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("utxorpc.v1.sync.FetchBlockRequest", len)?;
        if !self.r#ref.is_empty() {
...
impl<'de> serde::Deserialize<'de> for FetchBlockRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct utxorpc.v1.sync.FetchBlockRequest")
            }
        ...
        deserializer.deserialize_struct("utxorpc.v1.sync.FetchBlockRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for FetchBlockResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("utxorpc.v1.sync.FetchBlockResponse", len)?;
        if !self.block.is_empty() {
            struct_ser.serialize_field("block", &self.block)?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for FetchBlockResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct utxorpc.v1.sync.FetchBlockResponse")
            }
        ...
        deserializer.deserialize_struct("utxorpc.v1.sync.FetchBlockResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for FollowTipRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("utxorpc.v1.sync.FollowTipRequest", len)?;
        if !self.intersect.is_empty() {
...
impl<'de> serde::Deserialize<'de> for FollowTipRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct utxorpc.v1.sync.FollowTipRequest")
            }
        ...
        deserializer.deserialize_struct("utxorpc.v1.sync.FollowTipRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for FollowTipResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("utxorpc.v1.sync.FollowTipResponse", len)?;
...
impl<'de> serde::Deserialize<'de> for FollowTipResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct utxorpc.v1.sync.FollowTipResponse")
            }
...
;
        ...
        deserializer.deserialize_struct("utxorpc.v1.sync.FollowTipResponse", FIELDS, GeneratedVisitor)
    }
}
