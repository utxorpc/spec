...
impl serde::Serialize for AnyChainTx {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("utxorpc.v1alpha.submit.AnyChainTx", len)?;
...
impl<'de> serde::Deserialize<'de> for AnyChainTx {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct utxorpc.v1alpha.submit.AnyChainTx")
            }
        ...
        deserializer.deserialize_struct("utxorpc.v1alpha.submit.AnyChainTx", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for AnyChainTxPattern {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("utxorpc.v1alpha.submit.AnyChainTxPattern", len)?;
...
impl<'de> serde::Deserialize<'de> for AnyChainTxPattern {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct utxorpc.v1alpha.submit.AnyChainTxPattern")
            }
...
;
        ...
        deserializer.deserialize_struct("utxorpc.v1alpha.submit.AnyChainTxPattern", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ReadMempoolRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("utxorpc.v1alpha.submit.ReadMempoolRequest", len)?;
        if !self.txs.is_empty() {
...
impl<'de> serde::Deserialize<'de> for ReadMempoolRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct utxorpc.v1alpha.submit.ReadMempoolRequest")
            }
        ...
        deserializer.deserialize_struct("utxorpc.v1alpha.submit.ReadMempoolRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ReadMempoolResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("utxorpc.v1alpha.submit.ReadMempoolResponse", len)?;
        if !self.stage.is_empty() {
...
impl<'de> serde::Deserialize<'de> for ReadMempoolResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct utxorpc.v1alpha.submit.ReadMempoolResponse")
            }
        ...
        deserializer.deserialize_struct("utxorpc.v1alpha.submit.ReadMempoolResponse", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for SubmitTxRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("utxorpc.v1alpha.submit.SubmitTxRequest", len)?;
        if !self.tx.is_empty() {
...
impl<'de> serde::Deserialize<'de> for SubmitTxRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct utxorpc.v1alpha.submit.SubmitTxRequest")
            }
        ...
        deserializer.deserialize_struct("utxorpc.v1alpha.submit.SubmitTxRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for SubmitTxResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("utxorpc.v1alpha.submit.SubmitTxResponse", len)?;
        if !self.r#ref.is_empty() {
...
impl<'de> serde::Deserialize<'de> for SubmitTxResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct utxorpc.v1alpha.submit.SubmitTxResponse")
            }
        ...
        deserializer.deserialize_struct("utxorpc.v1alpha.submit.SubmitTxResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for TxInMempool {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("utxorpc.v1alpha.submit.TxInMempool", len)?;
...
impl<'de> serde::Deserialize<'de> for TxInMempool {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct utxorpc.v1alpha.submit.TxInMempool")
            }
        ...
        deserializer.deserialize_struct("utxorpc.v1alpha.submit.TxInMempool", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for TxPredicate {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("utxorpc.v1alpha.submit.TxPredicate", len)?;
...
impl<'de> serde::Deserialize<'de> for TxPredicate {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct utxorpc.v1alpha.submit.TxPredicate")
            }
        ...
        deserializer.deserialize_struct("utxorpc.v1alpha.submit.TxPredicate", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for WaitForTxRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("utxorpc.v1alpha.submit.WaitForTxRequest", len)?;
        if !self.r#ref.is_empty() {
            struct_ser.serialize_field("ref", &self.r#ref.iter().map(pbjson::private::base64::encode).collect::<Vec<_>>())?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for WaitForTxRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct utxorpc.v1alpha.submit.WaitForTxRequest")
            }
        ...
        deserializer.deserialize_struct("utxorpc.v1alpha.submit.WaitForTxRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for WaitForTxResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("utxorpc.v1alpha.submit.WaitForTxResponse", len)?;
        if !self.r#ref.is_empty() {
...
impl<'de> serde::Deserialize<'de> for WaitForTxResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct utxorpc.v1alpha.submit.WaitForTxResponse")
            }
        ...
        deserializer.deserialize_struct("utxorpc.v1alpha.submit.WaitForTxResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for WatchMempoolRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("utxorpc.v1alpha.submit.WatchMempoolRequest", len)?;
...
impl<'de> serde::Deserialize<'de> for WatchMempoolRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct utxorpc.v1alpha.submit.WatchMempoolRequest")
            }
        ...
        deserializer.deserialize_struct("utxorpc.v1alpha.submit.WatchMempoolRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for WatchMempoolResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("utxorpc.v1alpha.submit.WatchMempoolResponse", len)?;
        if let Some(v) = self.tx.as_ref() {
            struct_ser.serialize_field("tx", v)?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for WatchMempoolResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct utxorpc.v1alpha.submit.WatchMempoolResponse")
            }
        ...
        deserializer.deserialize_struct("utxorpc.v1alpha.submit.WatchMempoolResponse", FIELDS, GeneratedVisitor)
    }
}
