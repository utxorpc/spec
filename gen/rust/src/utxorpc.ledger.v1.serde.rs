...
impl serde::Serialize for Coin {
        ...
        S: serde::Serializer,
    {
        use serde::ser::SerializeStruct;
        let len = 0;
        let struct_ser = serializer.serialize_struct("utxorpc.ledger.v1.Coin", len)?;
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for Coin {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct utxorpc.ledger.v1.Coin")
            }
        ...
        deserializer.deserialize_struct("utxorpc.ledger.v1.Coin", FIELDS, GeneratedVisitor)
    }
}
                ...
                while let Some(k) = map.next_key()? {
                    match k {
                        ...
                        GeneratedField::TotalCollateral => {
                            ...
                            total_collateral__ = map.next_value()?;
                        }
                    }
                }
                Ok(Collateral {
