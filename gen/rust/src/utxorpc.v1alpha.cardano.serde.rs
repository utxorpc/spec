...
impl serde::Serialize for AssetPattern {
        ...
        S: serde::Serializer,
    {
        use serde::ser::SerializeStruct;
        let len = 0;
        let struct_ser = serializer.serialize_struct("utxorpc.v1alpha.cardano.AssetPattern", len)?;
        struct_ser.end()
    }
}
...
impl serde::Serialize for DatumPattern {
        ...
        S: serde::Serializer,
    {
        use serde::ser::SerializeStruct;
        let len = 0;
        let struct_ser = serializer.serialize_struct("utxorpc.v1alpha.cardano.DatumPattern", len)?;
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for DatumPattern {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct utxorpc.v1alpha.cardano.DatumPattern")
            }
        ...
        deserializer.deserialize_struct("utxorpc.v1alpha.cardano.DatumPattern", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for OutputPattern {
        ...
        S: serde::Serializer,
    {
        use serde::ser::SerializeStruct;
        let len = 0;
        let struct_ser = serializer.serialize_struct("utxorpc.v1alpha.cardano.OutputPattern", len)?;
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for OutputPattern {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct utxorpc.v1alpha.cardano.OutputPattern")
            }
        ...
        deserializer.deserialize_struct("utxorpc.v1alpha.cardano.OutputPattern", FIELDS, GeneratedVisitor)
    }
}
