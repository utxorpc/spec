...
impl serde::Serialize for AnyChainTx {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("utxorpc.v1.watch.AnyChainTx", len)?;
...
impl<'de> serde::Deserialize<'de> for AnyChainTx {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct utxorpc.v1.watch.AnyChainTx")
            }
...
;
        ...
        deserializer.deserialize_struct("utxorpc.v1.watch.AnyChainTx", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for AnyChainTxPattern {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("utxorpc.v1.watch.AnyChainTxPattern", len)?;
        if let Some(v) = self.chain.as_ref() {
            match v {
...
impl<'de> serde::Deserialize<'de> for AnyChainTxPattern {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct utxorpc.v1.watch.AnyChainTxPattern")
            }
...
;
        ...
        deserializer.deserialize_struct("utxorpc.v1.watch.AnyChainTxPattern", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for TxPredicate {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("utxorpc.v1.watch.TxPredicate", len)?;
...
impl<'de> serde::Deserialize<'de> for TxPredicate {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct utxorpc.v1.watch.TxPredicate")
            }
        ...
        deserializer.deserialize_struct("utxorpc.v1.watch.TxPredicate", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for WatchTxRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("utxorpc.v1.watch.WatchTxRequest", len)?;
...
impl<'de> serde::Deserialize<'de> for WatchTxRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct utxorpc.v1.watch.WatchTxRequest")
            }
        ...
        deserializer.deserialize_struct("utxorpc.v1.watch.WatchTxRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for WatchTxResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("utxorpc.v1.watch.WatchTxResponse", len)?;
...
impl<'de> serde::Deserialize<'de> for WatchTxResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct utxorpc.v1.watch.WatchTxResponse")
            }
...
;
        ...
        deserializer.deserialize_struct("utxorpc.v1.watch.WatchTxResponse", FIELDS, GeneratedVisitor)
    }
}
