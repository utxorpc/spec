...
// @generated from file utxorpc/v1/sync/sync.proto (package utxorpc.v1.sync, syntax proto3)
/* eslint-disable */
// @ts-nocheck

import type { BinaryReadOptions, FieldList, JsonReadOptions, JsonValue, PartialMessage, PlainMessage } from "@bufbuild/protobuf";
import { FieldMask, Message, proto3, protoInt64 } from "@bufbuild/protobuf";
import { Block } from "../cardano/cardano_pb.ts";

/**
 * Represents a reference to a specific block
 *
 * @generated from message utxorpc.v1.sync.BlockRef
 */
export class BlockRef extends Message<BlockRef> {
  ...
  static readonly typeName = "utxorpc.v1.sync.BlockRef";
...
/**
 * @generated from message utxorpc.v1.sync.AnyChainBlock
 */
export class AnyChainBlock extends Message<AnyChainBlock> {
  /**
   * @generated from oneof utxorpc.v1.sync.AnyChainBlock.chain
   */
  chain: {
    /**
     ...
     *
     * @generated from field: utxorpc.v1.cardano.Block cardano = 2;
     */
    value: Block;
    case: "cardano";
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "utxorpc.v1.sync.AnyChainBlock";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message utxorpc.v1.sync.FetchBlockRequest
 */
export class FetchBlockRequest extends Message<FetchBlockRequest> {
  /**
   * List of block references.
   *
   * @generated from field: repeated utxorpc.v1.sync.BlockRef ref = 1;
   */
  ref: BlockRef[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "utxorpc.v1.sync.FetchBlockRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message utxorpc.v1.sync.FetchBlockResponse
 */
export class FetchBlockResponse extends Message<FetchBlockResponse> {
  /**
   * List of fetched blocks.
   *
   * @generated from field: repeated utxorpc.v1.sync.AnyChainBlock block = 1;
   */
  block: AnyChainBlock[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "utxorpc.v1.sync.FetchBlockResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message utxorpc.v1.sync.DumpHistoryRequest
 */
export class DumpHistoryRequest extends Message<DumpHistoryRequest> {
  /**
   * Starting point for the block history dump.
   *
   * @generated from field: utxorpc.v1.sync.BlockRef start_token = 2;
   */
  startToken?: BlockRef;
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "utxorpc.v1.sync.DumpHistoryRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message utxorpc.v1.sync.DumpHistoryResponse
 */
export class DumpHistoryResponse extends Message<DumpHistoryResponse> {
   ...
   *
   * @generated from field: utxorpc.v1.sync.BlockRef next_token = 2;
   */
  nextToken?: BlockRef;
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "utxorpc.v1.sync.DumpHistoryResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "block", kind: "message", T: AnyChainBlock, repeated: true },
 ...
 *
 * @generated from message utxorpc.v1.sync.FollowTipRequest
 */
export class FollowTipRequest extends Message<FollowTipRequest> {
  /**
   * List of block references to find the intersection.
   *
   * @generated from field: repeated utxorpc.v1.sync.BlockRef intersect = 1;
   */
  intersect: BlockRef[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "utxorpc.v1.sync.FollowTipRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message utxorpc.v1.sync.FollowTipResponse
 */
export class FollowTipResponse extends Message<FollowTipResponse> {
  /**
   * @generated from oneof utxorpc.v1.sync.FollowTipResponse.action
   */
  action: {
    /**
     * Apply this block.
     *
     * @generated from field: utxorpc.v1.sync.AnyChainBlock apply = 1;
     */
    value: AnyChainBlock;
    case: "apply";
  } | {
     ...
     * Undo this block.
     *
     * @generated from field: utxorpc.v1.sync.AnyChainBlock undo = 2;
     */
    value: AnyChainBlock;
    case: "undo";
  } | {
     ...
     *
     * @generated from field: utxorpc.v1.sync.BlockRef reset = 3;
     */
    value: BlockRef;
    case: "reset";
  } | { case: undefined; value?: undefined } = { case: undefined };
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "utxorpc.v1.sync.FollowTipResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
