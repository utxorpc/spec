...
// @generated from file utxorpc/v1/cardano/cardano.proto (package utxorpc.v1.cardano, syntax proto3)
/* eslint-disable */
// @ts-nocheck
 ...
 *
 * @generated from enum utxorpc.v1.cardano.RedeemerPurpose
 */
...
proto3.util.setEnumType(RedeemerPurpose, "utxorpc.v1.cardano.RedeemerPurpose", [
...
/**
 * @generated from enum utxorpc.v1.cardano.MirSource
 */
...
proto3.util.setEnumType(MirSource, "utxorpc.v1.cardano.MirSource", [
 ...
 *
 * @generated from message utxorpc.v1.cardano.Redeemer
 */
export class Redeemer extends Message<Redeemer> {
  /**
   * Purpose of the redeemer.
   *
   * @generated from field: utxorpc.v1.cardano.RedeemerPurpose purpose = 1;
   */
   ...
   *
   * @generated from field: utxorpc.v1.cardano.PlutusData datum = 2;
   */
  datum?: PlutusData;
  ...
  static readonly typeName = "utxorpc.v1.cardano.Redeemer";
 ...
 *
 * @generated from message utxorpc.v1.cardano.TxInput
 */
export class TxInput extends Message<TxInput> {
   ...
   *
   * @generated from field: utxorpc.v1.cardano.TxOutput as_output = 3;
   */
  asOutput?: TxOutput;
   ...
   *
   * @generated from field: utxorpc.v1.cardano.Redeemer redeemer = 4;
   */
  redeemer?: Redeemer;
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "utxorpc.v1.cardano.TxInput";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message utxorpc.v1.cardano.TxOutput
 */
export class TxOutput extends Message<TxOutput> {
   ...
   *
   * @generated from field: repeated utxorpc.v1.cardano.Multiasset assets = 3;
   */
  assets: Multiasset[] = [];
   ...
   *
   * @generated from field: utxorpc.v1.cardano.PlutusData datum = 4;
   */
  datum?: PlutusData;
   ...
   *
   * @generated from field: utxorpc.v1.cardano.Script script = 6;
   */
  script?: Script;
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "utxorpc.v1.cardano.TxOutput";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message utxorpc.v1.cardano.Asset
 */
export class Asset extends Message<Asset> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "utxorpc.v1.cardano.Asset";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message utxorpc.v1.cardano.Multiasset
 */
export class Multiasset extends Message<Multiasset> {
   ...
   *
   * @generated from field: repeated utxorpc.v1.cardano.Asset assets = 2;
   */
  assets: Asset[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "utxorpc.v1.cardano.Multiasset";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message utxorpc.v1.cardano.TxValidity
 */
export class TxValidity extends Message<TxValidity> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "utxorpc.v1.cardano.TxValidity";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message utxorpc.v1.cardano.Collateral
 */
export class Collateral extends Message<Collateral> {
  /**
   * Collateral inputs for the transaction.
   *
   * @generated from field: repeated utxorpc.v1.cardano.TxInput collateral = 1;
   */
  collateral: TxInput[] = [];
   ...
   *
   * @generated from field: utxorpc.v1.cardano.TxOutput collateral_return = 2;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "utxorpc.v1.cardano.Collateral";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message utxorpc.v1.cardano.Withdrawal
 */
export class Withdrawal extends Message<Withdrawal> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "utxorpc.v1.cardano.Withdrawal";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message utxorpc.v1.cardano.WitnessSet
 */
export class WitnessSet extends Message<WitnessSet> {
  /**
   * List of VKey witnesses.
   *
   * @generated from field: repeated utxorpc.v1.cardano.VKeyWitness vkeywitness = 1;
   */
   ...
   * List of scripts.
   *
   * @generated from field: repeated utxorpc.v1.cardano.Script script = 2;
   */
  script: Script[] = [];
   ...
   *
   * @generated from field: repeated utxorpc.v1.cardano.PlutusData plutus_datums = 3;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "utxorpc.v1.cardano.WitnessSet";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message utxorpc.v1.cardano.AuxData
 */
export class AuxData extends Message<AuxData> {
  /**
   * List of auxiliary metadata elements.
   *
   * @generated from field: repeated utxorpc.v1.cardano.Metadata metadata = 1;
   */
  metadata: Metadata[] = [];
   ...
   *
   * @generated from field: repeated utxorpc.v1.cardano.Script scripts = 2;
   */
  scripts: Script[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "utxorpc.v1.cardano.AuxData";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message utxorpc.v1.cardano.Tx
 */
export class Tx extends Message<Tx> {
  /**
   * List of transaction inputs
   *
   * @generated from field: repeated utxorpc.v1.cardano.TxInput inputs = 1;
   */
  inputs: TxInput[] = [];
   ...
   *
   * @generated from field: repeated utxorpc.v1.cardano.TxOutput outputs = 2;
   */
  outputs: TxOutput[] = [];
   ...
   *
   * @generated from field: repeated utxorpc.v1.cardano.Certificate certificates = 3;
   */
   ...
   * List of withdrawals
   *
   * @generated from field: repeated utxorpc.v1.cardano.Withdrawal withdrawals = 4;
   */
   ...
   *
   * @generated from field: repeated utxorpc.v1.cardano.Multiasset mint = 5;
   */
  mint: Multiasset[] = [];
   ...
   *
   * @generated from field: repeated utxorpc.v1.cardano.TxInput reference_inputs = 6;
   */
   ...
   *
   * @generated from field: utxorpc.v1.cardano.WitnessSet witnesses = 7;
   */
   ...
   *
   * @generated from field: utxorpc.v1.cardano.Collateral collateral = 8;
   */
   ...
   *
   * @generated from field: utxorpc.v1.cardano.TxValidity validity = 10;
   */
  validity?: TxValidity;
   ...
   * Auxiliary data not directly tied to the validation process
   *
   * @generated from field: utxorpc.v1.cardano.AuxData auxiliary = 12;
   */
  auxiliary?: AuxData;
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "utxorpc.v1.cardano.Tx";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message utxorpc.v1.cardano.BlockHeader
 */
export class BlockHeader extends Message<BlockHeader> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "utxorpc.v1.cardano.BlockHeader";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message utxorpc.v1.cardano.BlockBody
 */
export class BlockBody extends Message<BlockBody> {
  /**
   * List of transactions.
   *
   * @generated from field: repeated utxorpc.v1.cardano.Tx tx = 1;
   */
  tx: Tx[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "utxorpc.v1.cardano.BlockBody";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message utxorpc.v1.cardano.Block
 */
export class Block extends Message<Block> {
  /**
   * Block header.
   *
   * @generated from field: utxorpc.v1.cardano.BlockHeader header = 1;
   */
  header?: BlockHeader;
   ...
   * Block body.
   *
   * @generated from field: utxorpc.v1.cardano.BlockBody body = 2;
   */
  body?: BlockBody;
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "utxorpc.v1.cardano.Block";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message utxorpc.v1.cardano.VKeyWitness
 */
export class VKeyWitness extends Message<VKeyWitness> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "utxorpc.v1.cardano.VKeyWitness";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message utxorpc.v1.cardano.NativeScript
 */
export class NativeScript extends Message<NativeScript> {
  /**
   * @generated from oneof utxorpc.v1.cardano.NativeScript.native_script
   */
  nativeScript: {
    /**
     ...
     *
     * @generated from field: utxorpc.v1.cardano.NativeScriptList script_all = 2;
     */
     ...
     *
     * @generated from field: utxorpc.v1.cardano.NativeScriptList script_any = 3;
     */
    value: NativeScriptList;
    case: "scriptAny";
  } | {
     ...
     *
     * @generated from field: utxorpc.v1.cardano.ScriptNOfK script_n_of_k = 4;
     */
    value: ScriptNOfK;
    case: "scriptNOfK";
  } | {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "utxorpc.v1.cardano.NativeScript";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message utxorpc.v1.cardano.NativeScriptList
 */
export class NativeScriptList extends Message<NativeScriptList> {
  /**
   * List of native scripts.
   *
   * @generated from field: repeated utxorpc.v1.cardano.NativeScript items = 1;
   */
  items: NativeScript[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "utxorpc.v1.cardano.NativeScriptList";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message utxorpc.v1.cardano.ScriptNOfK
 */
export class ScriptNOfK extends Message<ScriptNOfK> {
   ...
   * List of native scripts.
   *
   * @generated from field: repeated utxorpc.v1.cardano.NativeScript scripts = 2;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "utxorpc.v1.cardano.ScriptNOfK";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message utxorpc.v1.cardano.Constr
 */
export class Constr extends Message<Constr> {
  ...
  /**
   * @generated from field: repeated utxorpc.v1.cardano.PlutusData fields = 3;
   */
  fields: PlutusData[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "utxorpc.v1.cardano.Constr";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message utxorpc.v1.cardano.BigInt
 */
export class BigInt extends Message<BigInt> {
  /**
   * @generated from oneof utxorpc.v1.cardano.BigInt.big_int
   */
  bigInt: {
    /**
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "utxorpc.v1.cardano.BigInt";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message utxorpc.v1.cardano.PlutusDataPair
 */
export class PlutusDataPair extends Message<PlutusDataPair> {
  /**
   * Key of the pair.
   *
   * @generated from field: utxorpc.v1.cardano.PlutusData key = 1;
   */
  key?: PlutusData;
   ...
   * Value of the pair.
   *
   * @generated from field: utxorpc.v1.cardano.PlutusData value = 2;
   */
  value?: PlutusData;
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "utxorpc.v1.cardano.PlutusDataPair";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message utxorpc.v1.cardano.PlutusData
 */
export class PlutusData extends Message<PlutusData> {
  /**
   * @generated from oneof utxorpc.v1.cardano.PlutusData.plutus_data
   */
  plutusData: {
    /**
     * Constructor.
     *
     * @generated from field: utxorpc.v1.cardano.Constr constr = 1;
     */
    value: Constr;
    case: "constr";
  } | {
     ...
     * Map of Plutus data.
     *
     * @generated from field: utxorpc.v1.cardano.PlutusDataMap map = 2;
     */
    value: PlutusDataMap;
    case: "map";
  } | {
     ...
     * Big integer.
     *
     * @generated from field: utxorpc.v1.cardano.BigInt big_int = 3;
     */
    value: BigInt;
    case: "bigInt";
  } | {
     ...
     *
     * @generated from field: utxorpc.v1.cardano.PlutusDataArray array = 5;
     */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "utxorpc.v1.cardano.PlutusData";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message utxorpc.v1.cardano.PlutusDataMap
 */
export class PlutusDataMap extends Message<PlutusDataMap> {
  /**
   * List of key-value pairs.
   *
   * @generated from field: repeated utxorpc.v1.cardano.PlutusDataPair pairs = 1;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "utxorpc.v1.cardano.PlutusDataMap";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message utxorpc.v1.cardano.PlutusDataArray
 */
export class PlutusDataArray extends Message<PlutusDataArray> {
  /**
   * List of Plutus data items.
   *
   * @generated from field: repeated utxorpc.v1.cardano.PlutusData items = 1;
   */
  items: PlutusData[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "utxorpc.v1.cardano.PlutusDataArray";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message utxorpc.v1.cardano.Script
 */
export class Script extends Message<Script> {
  /**
   * @generated from oneof utxorpc.v1.cardano.Script.script
   */
  script: {
    /**
     * Native script.
     *
     * @generated from field: utxorpc.v1.cardano.NativeScript native = 1;
     */
    value: NativeScript;
    case: "native";
  } | {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "utxorpc.v1.cardano.Script";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message utxorpc.v1.cardano.Metadatum
 */
export class Metadatum extends Message<Metadatum> {
  /**
   * @generated from oneof utxorpc.v1.cardano.Metadatum.metadatum
   */
  metadatum: {
    /**
     * @generated from field: int64 int = 1;
    ...
    /**
     * @generated from field: utxorpc.v1.cardano.MetadatumArray array = 4;
     */
    value: MetadatumArray;
    case: "array";
  } | {
    /**
     * @generated from field: utxorpc.v1.cardano.MetadatumMap map = 5;
     */
    value: MetadatumMap;
    case: "map";
  } | { case: undefined; value?: undefined } = { case: undefined };
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "utxorpc.v1.cardano.Metadatum";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message utxorpc.v1.cardano.MetadatumArray
 */
export class MetadatumArray extends Message<MetadatumArray> {
  /**
   * @generated from field: repeated utxorpc.v1.cardano.Metadatum items = 1;
   */
  items: Metadatum[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "utxorpc.v1.cardano.MetadatumArray";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message utxorpc.v1.cardano.MetadatumMap
 */
export class MetadatumMap extends Message<MetadatumMap> {
  /**
   * @generated from field: repeated utxorpc.v1.cardano.MetadatumPair pairs = 1;
   */
  pairs: MetadatumPair[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "utxorpc.v1.cardano.MetadatumMap";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message utxorpc.v1.cardano.MetadatumPair
 */
export class MetadatumPair extends Message<MetadatumPair> {
  /**
   * @generated from field: utxorpc.v1.cardano.Metadatum key = 1;
   */
  key?: Metadatum;

  /**
   * @generated from field: utxorpc.v1.cardano.Metadatum value = 2;
   */
  value?: Metadatum;
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "utxorpc.v1.cardano.MetadatumPair";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message utxorpc.v1.cardano.Metadata
 */
export class Metadata extends Message<Metadata> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "utxorpc.v1.cardano.Metadata";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message utxorpc.v1.cardano.StakeCredential
 */
export class StakeCredential extends Message<StakeCredential> {
  /**
   * @generated from oneof utxorpc.v1.cardano.StakeCredential.stake_credential
   */
  stakeCredential: {
    /**
     * Address key hash.
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "utxorpc.v1.cardano.StakeCredential";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message utxorpc.v1.cardano.RationalNumber
 */
export class RationalNumber extends Message<RationalNumber> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "utxorpc.v1.cardano.RationalNumber";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message utxorpc.v1.cardano.Relay
 */
export class Relay extends Message<Relay> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "utxorpc.v1.cardano.Relay";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message utxorpc.v1.cardano.PoolMetadata
 */
export class PoolMetadata extends Message<PoolMetadata> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "utxorpc.v1.cardano.PoolMetadata";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message utxorpc.v1.cardano.Certificate
 */
export class Certificate extends Message<Certificate> {
  /**
   * @generated from oneof utxorpc.v1.cardano.Certificate.certificate
   */
  certificate: {
    /**
     * Stake registration certificate.
     *
     * @generated from field: utxorpc.v1.cardano.StakeCredential stake_registration = 1;
     */
     ...
     *
     * @generated from field: utxorpc.v1.cardano.StakeCredential stake_deregistration = 2;
     */
    value: StakeCredential;
     ...
     *
     * @generated from field: utxorpc.v1.cardano.StakeDelegationCert stake_delegation = 3;
     */
     ...
     *
     * @generated from field: utxorpc.v1.cardano.PoolRegistrationCert pool_registration = 4;
     */
     ...
     *
     * @generated from field: utxorpc.v1.cardano.PoolRetirementCert pool_retirement = 5;
     */
     ...
     *
     * @generated from field: utxorpc.v1.cardano.GenesisKeyDelegationCert genesis_key_delegation = 6;
     */
     ...
     *
     * @generated from field: utxorpc.v1.cardano.MirCert mir_cert = 7;
     */
    value: MirCert;
    case: "mirCert";
  } | { case: undefined; value?: undefined } = { case: undefined };
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "utxorpc.v1.cardano.Certificate";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message utxorpc.v1.cardano.StakeDelegationCert
 */
export class StakeDelegationCert extends Message<StakeDelegationCert> {
  /**
   * Stake credential.
   *
   * @generated from field: utxorpc.v1.cardano.StakeCredential stake_credential = 1;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "utxorpc.v1.cardano.StakeDelegationCert";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message utxorpc.v1.cardano.PoolRegistrationCert
 */
export class PoolRegistrationCert extends Message<PoolRegistrationCert> {
   ...
   * Pool margin.
   *
   * @generated from field: utxorpc.v1.cardano.RationalNumber margin = 5;
   */
   ...
   * List of relays.
   *
   * @generated from field: repeated utxorpc.v1.cardano.Relay relays = 8;
   */
  relays: Relay[] = [];
   ...
   * Pool metadata.
   *
   * @generated from field: utxorpc.v1.cardano.PoolMetadata pool_metadata = 9;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "utxorpc.v1.cardano.PoolRegistrationCert";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message utxorpc.v1.cardano.PoolRetirementCert
 */
export class PoolRetirementCert extends Message<PoolRetirementCert> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "utxorpc.v1.cardano.PoolRetirementCert";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message utxorpc.v1.cardano.GenesisKeyDelegationCert
 */
export class GenesisKeyDelegationCert extends Message<GenesisKeyDelegationCert> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "utxorpc.v1.cardano.GenesisKeyDelegationCert";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message utxorpc.v1.cardano.MirTarget
 */
export class MirTarget extends Message<MirTarget> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "utxorpc.v1.cardano.MirTarget";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "stake_credential", kind: "message", T: StakeCredential },
 ...
 *
 * @generated from message utxorpc.v1.cardano.MirCert
 */
export class MirCert extends Message<MirCert> {
  /**
   * @generated from field: utxorpc.v1.cardano.MirSource from = 1;
   */
  from = MirSource.UNSPECIFIED;

  /**
   * @generated from field: repeated utxorpc.v1.cardano.MirTarget to = 2;
   */
  to: MirTarget[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "utxorpc.v1.cardano.MirCert";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message utxorpc.v1.cardano.AddressPattern
 */
export class AddressPattern extends Message<AddressPattern> {
  /**
   * @generated from field: bytes byron_address = 1;
   */
  byronAddress = new Uint8Array(0);
  ...
  /**
   * @generated from field: bool payment_is_script = 4;
   */
  paymentIsScript = false;

  /**
   * @generated from field: bool delegation_is_script = 5;
   */
  delegationIsScript = false;
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "utxorpc.v1.cardano.AddressPattern";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "byron_address", kind: "scalar", T: 12 /* ScalarType.BYTES */ },
    { no: 2, name: "payment_part", kind: "scalar", T: 12 /* ScalarType.BYTES */ },
    { no: 3, name: "delegation_part", kind: "scalar", T: 12 /* ScalarType.BYTES */ },
    { no: 4, name: "payment_is_script", kind: "scalar", T: 8 /* ScalarType.BOOL */ },
    { no: 5, name: "delegation_is_script", kind: "scalar", T: 8 /* ScalarType.BOOL */ },
  ]);
 ...
 * TBD
 *
 * @generated from message utxorpc.v1.cardano.AssetPattern
 */
export class AssetPattern extends Message<AssetPattern> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "utxorpc.v1.cardano.AssetPattern";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
 ...
 * TBD
 *
 * @generated from message utxorpc.v1.cardano.OutputPattern
 */
export class OutputPattern extends Message<OutputPattern> {
  constructor(data?: PartialMessage<OutputPattern>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "utxorpc.v1.cardano.OutputPattern";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): OutputPattern {
    return new OutputPattern().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): OutputPattern {
    return new OutputPattern().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): OutputPattern {
    return new OutputPattern().fromJsonString(jsonString, options);
  }

  static equals(a: OutputPattern | PlainMessage<OutputPattern> | undefined, b: OutputPattern | PlainMessage<OutputPattern> | undefined): boolean {
    return proto3.util.equals(OutputPattern, a, b);
  }
}
 ...
 * TBD
 *
 * @generated from message utxorpc.v1.cardano.DatumPattern
 */
export class DatumPattern extends Message<DatumPattern> {
  constructor(data?: PartialMessage<DatumPattern>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "utxorpc.v1.cardano.DatumPattern";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): DatumPattern {
    return new DatumPattern().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): DatumPattern {
    return new DatumPattern().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): DatumPattern {
    return new DatumPattern().fromJsonString(jsonString, options);
  }

  static equals(a: DatumPattern | PlainMessage<DatumPattern> | undefined, b: DatumPattern | PlainMessage<DatumPattern> | undefined): boolean {
    return proto3.util.equals(DatumPattern, a, b);
  }
}
 ...
 *
 * @generated from message utxorpc.v1.cardano.TxPattern
 */
export class TxPattern extends Message<TxPattern> {
  /**
   * @generated from oneof utxorpc.v1.cardano.TxPattern.tx_pattern
   */
  txPattern: {
    /**
     * Match any output that exhibits this pattern.
     *
     * @generated from field: utxorpc.v1.cardano.OutputPattern any_output = 1;
     */
    value: OutputPattern;
    case: "anyOutput";
  } | {
     ...
     *
     * @generated from field: utxorpc.v1.cardano.AddressPattern any_address = 2;
     */
     ...
     *
     * @generated from field: utxorpc.v1.cardano.AssetPattern any_asset = 3;
     */
    value: AssetPattern;
    case: "anyAsset";
  } | {
     ...
     *
     * @generated from field: utxorpc.v1.cardano.DatumPattern any_datum = 4;
     */
    value: DatumPattern;
    case: "anyDatum";
  } | { case: undefined; value?: undefined } = { case: undefined };
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "utxorpc.v1.cardano.TxPattern";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "any_output", kind: "message", T: OutputPattern, oneof: "tx_pattern" },
    { no: 2, name: "any_address", kind: "message", T: AddressPattern, oneof: "tx_pattern" },
    { no: 3, name: "any_asset", kind: "message", T: AssetPattern, oneof: "tx_pattern" },
    { no: 4, name: "any_datum", kind: "message", T: DatumPattern, oneof: "tx_pattern" },
  ]);
