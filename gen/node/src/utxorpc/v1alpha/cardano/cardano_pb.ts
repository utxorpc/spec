...
export class Redeemer extends Message<Redeemer> {
   ...
   *
   * @generated from field: utxorpc.v1alpha.cardano.PlutusData datum = 2;
   */
  datum?: PlutusData;
...
export class TxOutput extends Message<TxOutput> {
   ...
   *
   * @generated from field: utxorpc.v1alpha.cardano.PlutusData datum = 4;
   */
  datum?: PlutusData;
   ...
   *
   * @generated from field: utxorpc.v1alpha.cardano.Script script = 6;
   */
  script?: Script;
...
export class PlutusData extends Message<PlutusData> {
  ...
  plutusData: {
     ...
     * Constructor.
     *
     * @generated from field: utxorpc.v1alpha.cardano.Constr constr = 1;
     */
    value: Constr;
    case: "constr";
  } | {
     ...
     * Map of Plutus data.
     *
     * @generated from field: utxorpc.v1alpha.cardano.PlutusDataMap map = 2;
     */
    value: PlutusDataMap;
    case: "map";
  } | {
     ...
     * Big integer.
     *
     * @generated from field: utxorpc.v1alpha.cardano.BigInt big_int = 3;
     */
    value: BigInt;
    case: "bigInt";
  } | {
     ...
     *
     * @generated from field: utxorpc.v1alpha.cardano.PlutusDataArray array = 5;
     */
 ...
 * TBD
 *
 * @generated from message utxorpc.v1alpha.cardano.OutputPattern
 */
export class OutputPattern extends Message<OutputPattern> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "utxorpc.v1alpha.cardano.OutputPattern";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
 ...
 * TBD
 *
 * @generated from message utxorpc.v1alpha.cardano.DatumPattern
 */
export class DatumPattern extends Message<DatumPattern> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "utxorpc.v1alpha.cardano.DatumPattern";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
...
export class TxPattern extends Message<TxPattern> {
  /**
   * @generated from oneof utxorpc.v1alpha.cardano.TxPattern.tx_pattern
   */
  txPattern: {
    /**
     * Match any output that exhibits this pattern.
     *
     * @generated from field: utxorpc.v1alpha.cardano.OutputPattern any_output = 1;
     */
    value: OutputPattern;
    case: "anyOutput";
  } | {
     ...
     *
     * @generated from field: utxorpc.v1alpha.cardano.AddressPattern any_address = 2;
     */
     ...
     *
     * @generated from field: utxorpc.v1alpha.cardano.AssetPattern any_asset = 3;
     */
    value: AssetPattern;
    case: "anyAsset";
  } | {
     ...
     *
     * @generated from field: utxorpc.v1alpha.cardano.DatumPattern any_datum = 4;
     */
    value: DatumPattern;
    case: "anyDatum";
  } | { case: undefined; value?: undefined } = { case: undefined };
