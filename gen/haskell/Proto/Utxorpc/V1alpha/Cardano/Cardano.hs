...
instance Data.ProtoLens.Message AddressPattern where
  messageName _ = Data.Text.pack "utxorpc.v1alpha.cardano.AddressPattern"
...
instance Data.ProtoLens.Message AssetPattern where
  messageName _ = Data.Text.pack "utxorpc.v1alpha.cardano.AssetPattern"
  packedMessageDescriptor _
    = "\n\
      \\fAssetPattern"
  packedFileDescriptor _ = packedFileDescriptor
...
instance Data.ProtoLens.Message AuxData where
  ...
  packedMessageDescriptor _
    = "\n\
      ...
      \\ascripts\CAN\STX \ETX(\v2\SUB.utxorpc.v1alpha.cardano.ScriptR\ascripts"
  packedFileDescriptor _ = packedFileDescriptor
  fieldsByTag
    = let
...
instance Data.ProtoLens.Message BlockBody where
  ...
  packedMessageDescriptor _
    = "\n\
      \\tBlockBody\DC2&\n\
      \\STXtx\CAN\SOH \ETX(\v2\SYN.utxorpc.v1alpha.cardano.TxR\STXtx"
  packedFileDescriptor _ = packedFileDescriptor
  fieldsByTag
    = let
...
instance Data.ProtoLens.Message BlockHeader where
  messageName _ = Data.Text.pack "utxorpc.v1alpha.cardano.BlockHeader"
  packedMessageDescriptor _
    = "\n\
...
instance Data.ProtoLens.Message Certificate where
  messageName _ = Data.Text.pack "utxorpc.v1alpha.cardano.Certificate"
  packedMessageDescriptor _
    = "\n\
      \\vCertificate\DC2T\n\
...
instance Data.ProtoLens.Message Constr where
  ...
  packedMessageDescriptor _
    = "\n\
      ...
      \\ACKfields\CAN\ETX \ETX(\v2\RS.utxorpc.v1alpha.cardano.PlutusDataR\ACKfields"
  packedFileDescriptor _ = packedFileDescriptor
  fieldsByTag
    = let
...
instance Data.ProtoLens.Message DatumPattern where
  messageName _ = Data.Text.pack "utxorpc.v1alpha.cardano.DatumPattern"
  packedMessageDescriptor _
    = "\n\
      \\fDatumPattern"
  packedFileDescriptor _ = packedFileDescriptor
...
instance Data.ProtoLens.Message Metadata where
  ...
  packedMessageDescriptor _
    = "\n\
      ...
      \\ENQvalue\CAN\STX \SOH(\v2\GS.utxorpc.v1alpha.cardano.MetadatumR\ENQvalue"
  packedFileDescriptor _ = packedFileDescriptor
  fieldsByTag
    = let
...
instance Data.ProtoLens.Message MetadatumArray where
  messageName _ = Data.Text.pack "utxorpc.v1alpha.cardano.MetadatumArray"
  packedMessageDescriptor _
    = "\n\
      \\SOMetadatumArray\DC23\n\
      \\ENQitems\CAN\SOH \ETX(\v2\GS.utxorpc.v1alpha.cardano.MetadatumR\ENQitems"
  packedFileDescriptor _ = packedFileDescriptor
  fieldsByTag
    = let
...
instance Data.ProtoLens.Message MetadatumMap where
  messageName _ = Data.Text.pack "utxorpc.v1alpha.cardano.MetadatumMap"
  packedMessageDescriptor _
    = "\n\
      \\fMetadatumMap\DC27\n\
...
instance Data.ProtoLens.Message MetadatumPair where
  messageName _ = Data.Text.pack "utxorpc.v1alpha.cardano.MetadatumPair"
  packedMessageDescriptor _
    = "\n\
      \\rMetadatumPair\DC2/\n\
...
instance Data.ProtoLens.Message Multiasset where
  ...
  packedMessageDescriptor _
    = "\n\
      ...
      \\ACKassets\CAN\STX \ETX(\v2\EM.utxorpc.v1alpha.cardano.AssetR\ACKassets"
  packedFileDescriptor _ = packedFileDescriptor
  fieldsByTag
    = let
...
instance Data.ProtoLens.Message NativeScript where
  messageName _ = Data.Text.pack "utxorpc.v1alpha.cardano.NativeScript"
  packedMessageDescriptor _
    = "\n\
      \\fNativeScript\DC2%\n\
...
instance Data.ProtoLens.Message OutputPattern where
  messageName _ = Data.Text.pack "utxorpc.v1alpha.cardano.OutputPattern"
  packedMessageDescriptor _
    = "\n\
      \\rOutputPattern"
  packedFileDescriptor _ = packedFileDescriptor
...
instance Data.ProtoLens.Message PlutusDataArray where
  messageName _ = Data.Text.pack "utxorpc.v1alpha.cardano.PlutusDataArray"
  packedMessageDescriptor _
    = "\n\
      \\SIPlutusDataArray\DC24\n\
      \\ENQitems\CAN\SOH \ETX(\v2\RS.utxorpc.v1alpha.cardano.PlutusDataR\ENQitems"
  packedFileDescriptor _ = packedFileDescriptor
  fieldsByTag
    = let
        items__field_descriptor
...
instance Data.ProtoLens.Message PlutusDataMap where
  messageName _ = Data.Text.pack "utxorpc.v1alpha.cardano.PlutusDataMap"
  packedMessageDescriptor _
    = "\n\
      \\rPlutusDataMap\DC28\n\
...
instance Data.ProtoLens.Message PlutusDataPair where
  messageName _ = Data.Text.pack "utxorpc.v1alpha.cardano.PlutusDataPair"
  packedMessageDescriptor _
    = "\n\
      \\SOPlutusDataPair\DC20\n\
      \\ETXkey\CAN\SOH \SOH(\v2\RS.utxorpc.v1alpha.cardano.PlutusDataR\ETXkey\DC24\n\
      \\ENQvalue\CAN\STX \SOH(\v2\RS.utxorpc.v1alpha.cardano.PlutusDataR\ENQvalue"
  packedFileDescriptor _ = packedFileDescriptor
  fieldsByTag
    = let
        key__field_descriptor
...
instance Data.ProtoLens.Message PoolMetadata where
  messageName _ = Data.Text.pack "utxorpc.v1alpha.cardano.PoolMetadata"
  packedMessageDescriptor _
    = "\n\
...
instance Data.ProtoLens.Message RationalNumber where
  messageName _ = Data.Text.pack "utxorpc.v1alpha.cardano.RationalNumber"
  packedMessageDescriptor _
    = "\n\
...
instance Data.ProtoLens.Message Redeemer where
  ...
  packedMessageDescriptor _
    = "\n\
      ...
      \\ENQdatum\CAN\STX \SOH(\v2\RS.utxorpc.v1alpha.cardano.PlutusDataR\ENQdatum"
  packedFileDescriptor _ = packedFileDescriptor
  fieldsByTag
    = let
...
instance Data.ProtoLens.Message StakeCredential where
  messageName _ = Data.Text.pack "utxorpc.v1alpha.cardano.StakeCredential"
  packedMessageDescriptor _
    = "\n\
...
instance Data.ProtoLens.Message Tx where
  ...
  packedMessageDescriptor _
    = "\n\
      ...
      \successful\DC29\n\
      \\tauxiliary\CAN\f \SOH(\v2\ESC.utxorpc.v1alpha.cardano.AuxDataR\tauxiliary"
  packedFileDescriptor _ = packedFileDescriptor
  fieldsByTag
    = let
...
instance Data.ProtoLens.Message TxInput where
  ...
  packedMessageDescriptor _
    = "\n\
      ...
      \\bredeemer\CAN\EOT \SOH(\v2\FS.utxorpc.v1alpha.cardano.RedeemerR\bredeemer"
  packedFileDescriptor _ = packedFileDescriptor
  fieldsByTag
    = let
...
instance Data.ProtoLens.Message TxOutput where
  ...
  packedMessageDescriptor _
    = "\n\
      ...
      \\ACKscript\CAN\ACK \SOH(\v2\SUB.utxorpc.v1alpha.cardano.ScriptR\ACKscript"
  packedFileDescriptor _ = packedFileDescriptor
  fieldsByTag
    = let
...
instance Data.ProtoLens.Message VKeyWitness where
  messageName _ = Data.Text.pack "utxorpc.v1alpha.cardano.VKeyWitness"
  packedMessageDescriptor _
    = "\n\
...
instance Data.ProtoLens.Message WitnessSet where
  ...
  packedMessageDescriptor _
    = "\n\
      ...
      \\rplutus_datums\CAN\ETX \ETX(\v2\RS.utxorpc.v1alpha.cardano.PlutusDataR\fplutusDatums"
  packedFileDescriptor _ = packedFileDescriptor
  fieldsByTag
    = let
