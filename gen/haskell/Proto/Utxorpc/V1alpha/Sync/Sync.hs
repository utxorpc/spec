...
instance Data.ProtoLens.Message DumpHistoryRequest where
  messageName _ = Data.Text.pack "utxorpc.v1alpha.sync.DumpHistoryRequest"
  packedMessageDescriptor _
    = "\n\
...
instance Data.ProtoLens.Message DumpHistoryResponse where
  ...
  packedMessageDescriptor _
    = "\n\
      ...
      \\n\
      \next_token\CAN\STX \SOH(\v2\EM.utxorpc.v1alpha.sync.BlockRefR\tnextToken"
  packedFileDescriptor _ = packedFileDescriptor
  fieldsByTag
    = let
...
instance Data.ProtoLens.Message FetchBlockRequest where
  messageName _ = Data.Text.pack "utxorpc.v1alpha.sync.FetchBlockRequest"
  packedMessageDescriptor _
    = "\n\
...
instance Data.ProtoLens.Message FetchBlockResponse where
  messageName _ = Data.Text.pack "utxorpc.v1alpha.sync.FetchBlockResponse"
  packedMessageDescriptor _
    = "\n\
      \\DC2FetchBlockResponse\DC24\n\
      \\ENQblock\CAN\SOH \ETX(\v2\RS.utxorpc.v1alpha.sync.AnyChainBlockR\ENQblock"
  packedFileDescriptor _ = packedFileDescriptor
  fieldsByTag
    = let
        block__field_descriptor
...
instance Data.ProtoLens.Message FollowTipRequest where
  messageName _ = Data.Text.pack "utxorpc.v1alpha.sync.FollowTipRequest"
  packedMessageDescriptor _
    = "\n\
      \\DLEFollowTipRequest\DC27\n\
      \\tintersect\CAN\SOH \ETX(\v2\EM.utxorpc.v1alpha.sync.BlockRefR\tintersect"
  packedFileDescriptor _ = packedFileDescriptor
  fieldsByTag
    = let
...
instance Data.ProtoLens.Message FollowTipResponse where
  messageName _ = Data.Text.pack "utxorpc.v1alpha.sync.FollowTipResponse"
  packedMessageDescriptor _
    = "\n\
