{- This file was auto-generated from utxorpc/v1alpha/sync/sync.proto by the proto-lens-protoc program. -}
...
{- | Fields :
         ...
         * 'Proto.Utxorpc.V1alpha.Sync.Sync_Fields.maybe'chain' @:: Lens' AnyChainBlock (Prelude.Maybe AnyChainBlock'Chain)@
         * 'Proto.Utxorpc.V1alpha.Sync.Sync_Fields.maybe'raw' @:: Lens' AnyChainBlock (Prelude.Maybe Data.ByteString.ByteString)@
         * 'Proto.Utxorpc.V1alpha.Sync.Sync_Fields.raw' @:: Lens' AnyChainBlock Data.ByteString.ByteString@
         * 'Proto.Utxorpc.V1alpha.Sync.Sync_Fields.maybe'cardano' @:: Lens' AnyChainBlock (Prelude.Maybe Proto.Utxorpc.V1alpha.Cardano.Cardano.Block)@
         * 'Proto.Utxorpc.V1alpha.Sync.Sync_Fields.cardano' @:: Lens' AnyChainBlock Proto.Utxorpc.V1alpha.Cardano.Cardano.Block@ -}
data AnyChainBlock
...
instance Data.ProtoLens.Message AnyChainBlock where
  messageName _ = Data.Text.pack "utxorpc.v1alpha.sync.AnyChainBlock"
  packedMessageDescriptor _
    = "\n\
      \\rAnyChainBlock\DC2\DC2\n\
      \\ETXraw\CAN\SOH \SOH(\fH\NULR\ETXraw\DC2:\n\
...
{- | Fields :
         ...
         * 'Proto.Utxorpc.V1alpha.Sync.Sync_Fields.index' @:: Lens' BlockRef Data.Word.Word64@
         * 'Proto.Utxorpc.V1alpha.Sync.Sync_Fields.hash' @:: Lens' BlockRef Data.ByteString.ByteString@ -}
data BlockRef
...
instance Data.ProtoLens.Message BlockRef where
  messageName _ = Data.Text.pack "utxorpc.v1alpha.sync.BlockRef"
  packedMessageDescriptor _
    = "\n\
      \\bBlockRef\DC2\DC4\n\
...
{- | Fields :
         ...
         * 'Proto.Utxorpc.V1alpha.Sync.Sync_Fields.startToken' @:: Lens' DumpHistoryRequest BlockRef@
         * 'Proto.Utxorpc.V1alpha.Sync.Sync_Fields.maybe'startToken' @:: Lens' DumpHistoryRequest (Prelude.Maybe BlockRef)@
         * 'Proto.Utxorpc.V1alpha.Sync.Sync_Fields.maxItems' @:: Lens' DumpHistoryRequest Data.Word.Word32@
         * 'Proto.Utxorpc.V1alpha.Sync.Sync_Fields.fieldMask' @:: Lens' DumpHistoryRequest Proto.Google.Protobuf.FieldMask.FieldMask@
         * 'Proto.Utxorpc.V1alpha.Sync.Sync_Fields.maybe'fieldMask' @:: Lens' DumpHistoryRequest (Prelude.Maybe Proto.Google.Protobuf.FieldMask.FieldMask)@ -}
...
instance Data.ProtoLens.Message DumpHistoryRequest where
  messageName _
    = Data.Text.pack "utxorpc.v1alpha.sync.DumpHistoryRequest"
  packedMessageDescriptor _
    = "\n\
...
{- | Fields :
         ...
         * 'Proto.Utxorpc.V1alpha.Sync.Sync_Fields.block' @:: Lens' DumpHistoryResponse [AnyChainBlock]@
         * 'Proto.Utxorpc.V1alpha.Sync.Sync_Fields.vec'block' @:: Lens' DumpHistoryResponse (Data.Vector.Vector AnyChainBlock)@
         * 'Proto.Utxorpc.V1alpha.Sync.Sync_Fields.nextToken' @:: Lens' DumpHistoryResponse BlockRef@
         * 'Proto.Utxorpc.V1alpha.Sync.Sync_Fields.maybe'nextToken' @:: Lens' DumpHistoryResponse (Prelude.Maybe BlockRef)@ -}
...
instance Data.ProtoLens.Message DumpHistoryResponse where
  messageName _
    = Data.Text.pack "utxorpc.v1alpha.sync.DumpHistoryResponse"
  packedMessageDescriptor _
    = "\n\
...
{- | Fields :
         ...
         * 'Proto.Utxorpc.V1alpha.Sync.Sync_Fields.ref' @:: Lens' FetchBlockRequest [BlockRef]@
         * 'Proto.Utxorpc.V1alpha.Sync.Sync_Fields.vec'ref' @:: Lens' FetchBlockRequest (Data.Vector.Vector BlockRef)@
         * 'Proto.Utxorpc.V1alpha.Sync.Sync_Fields.fieldMask' @:: Lens' FetchBlockRequest Proto.Google.Protobuf.FieldMask.FieldMask@
         * 'Proto.Utxorpc.V1alpha.Sync.Sync_Fields.maybe'fieldMask' @:: Lens' FetchBlockRequest (Prelude.Maybe Proto.Google.Protobuf.FieldMask.FieldMask)@ -}
...
instance Data.ProtoLens.Message FetchBlockRequest where
  messageName _
    = Data.Text.pack "utxorpc.v1alpha.sync.FetchBlockRequest"
  packedMessageDescriptor _
    = "\n\
...
{- | Fields :
         ...
         * 'Proto.Utxorpc.V1alpha.Sync.Sync_Fields.block' @:: Lens' FetchBlockResponse [AnyChainBlock]@
         * 'Proto.Utxorpc.V1alpha.Sync.Sync_Fields.vec'block' @:: Lens' FetchBlockResponse (Data.Vector.Vector AnyChainBlock)@ -}
...
instance Data.ProtoLens.Message FetchBlockResponse where
  messageName _
    = Data.Text.pack "utxorpc.v1alpha.sync.FetchBlockResponse"
  packedMessageDescriptor _
    = "\n\
...
{- | Fields :
         ...
         * 'Proto.Utxorpc.V1alpha.Sync.Sync_Fields.intersect' @:: Lens' FollowTipRequest [BlockRef]@
         * 'Proto.Utxorpc.V1alpha.Sync.Sync_Fields.vec'intersect' @:: Lens' FollowTipRequest (Data.Vector.Vector BlockRef)@ -}
...
instance Data.ProtoLens.Message FollowTipRequest where
  messageName _
    = Data.Text.pack "utxorpc.v1alpha.sync.FollowTipRequest"
  packedMessageDescriptor _
    = "\n\
      \\DLEFollowTipRequest\DC2<\n\
      \\tintersect\CAN\SOH \ETX(\v2\RS.utxorpc.v1alpha.sync.BlockRefR\tintersect"
  packedFileDescriptor _ = packedFileDescriptor
  fieldsByTag
    = let
...
{- | Fields :
         ...
         * 'Proto.Utxorpc.V1alpha.Sync.Sync_Fields.maybe'action' @:: Lens' FollowTipResponse (Prelude.Maybe FollowTipResponse'Action)@
         * 'Proto.Utxorpc.V1alpha.Sync.Sync_Fields.maybe'apply' @:: Lens' FollowTipResponse (Prelude.Maybe AnyChainBlock)@
         * 'Proto.Utxorpc.V1alpha.Sync.Sync_Fields.apply' @:: Lens' FollowTipResponse AnyChainBlock@
         * 'Proto.Utxorpc.V1alpha.Sync.Sync_Fields.maybe'undo' @:: Lens' FollowTipResponse (Prelude.Maybe AnyChainBlock)@
         * 'Proto.Utxorpc.V1alpha.Sync.Sync_Fields.undo' @:: Lens' FollowTipResponse AnyChainBlock@
         * 'Proto.Utxorpc.V1alpha.Sync.Sync_Fields.maybe'reset' @:: Lens' FollowTipResponse (Prelude.Maybe BlockRef)@
         * 'Proto.Utxorpc.V1alpha.Sync.Sync_Fields.reset' @:: Lens' FollowTipResponse BlockRef@ -}
...
instance Data.ProtoLens.Message FollowTipResponse where
  messageName _
    = Data.Text.pack "utxorpc.v1alpha.sync.FollowTipResponse"
  packedMessageDescriptor _
    = "\n\
...
instance Data.ProtoLens.Service.Types.Service ChainSyncService where
  ...
  type ServicePackage ChainSyncService = "utxorpc.v1alpha.sync"
  type ServiceMethods ChainSyncService = '["dumpHistory",
                                           "fetchBlock",
                                           "followTip"]
  packedServiceDescriptor _
    = "\n\
      \\DLEChainSyncService\DC2_\n\
      \\n\
...
packedFileDescriptor
  = "\n\
    ...
    \\ENQblock\CAN\SOH \ETX(\v2#.utxorpc.v1alpha.sync.AnyChainBlockR\ENQblock\DC2=\n\
    \\n\
    \next_token\CAN\STX \SOH(\v2\RS.utxorpc.v1alpha.sync.BlockRefR\tnextToken\"P\n\
    \\DLEFollowTipRequest\DC2<\n\
    \\tintersect\CAN\SOH \ETX(\v2\RS.utxorpc.v1alpha.sync.BlockRefR\tintersect\"\205\SOH\n\
    \\DC1FollowTipResponse\DC2;\n\
    \\ENQapply\CAN\SOH \SOH(\v2#.utxorpc.v1alpha.sync.AnyChainBlockH\NULR\ENQapply\DC29\n\
    \\EOTundo\CAN\STX \SOH(\v2#.utxorpc.v1alpha.sync.AnyChainBlockH\NULR\EOTundo\DC26\n\
    \\ENQreset\CAN\ETX \SOH(\v2\RS.utxorpc.v1alpha.sync.BlockRefH\NULR\ENQresetB\b\n\
    ...
    \FetchBlock\DC2'.utxorpc.v1alpha.sync.FetchBlockRequest\SUB(.utxorpc.v1alpha.sync.FetchBlockResponse\DC2b\n\
    \\vDumpHistory\DC2(.utxorpc.v1alpha.sync.DumpHistoryRequest\SUB).utxorpc.v1alpha.sync.DumpHistoryResponse\DC2^\n\
    \\tFollowTip\DC2&.utxorpc.v1alpha.sync.FollowTipRequest\SUB'.utxorpc.v1alpha.sync.FollowTipResponse0\SOHB\204\SOH\n\
    \\CANcom.utxorpc.v1alpha.syncB\tSyncProtoP\SOHZ3github.com/utxorpc/go-sdk/spec/utxorpc/v1alpha/sync\162\STX\ETXUVS\170\STX\DC4Utxorpc.V1alpha.Sync\202\STX\DC4Utxorpc\\V1alpha\\Sync\226\STX Utxorpc\\V1alpha\\Sync\\GPBMetadata\234\STX\SYNUtxorpc::V1alpha::SyncJ\191\DC3\n\
