...
module Proto.Utxorpc.V1.Sync.Sync (
...
{- | Fields :
         ...
         * 'Proto.Utxorpc.V1.Sync.Sync_Fields.maybe'chain' @:: Lens' AnyChainBlock (Prelude.Maybe AnyChainBlock'Chain)@
         * 'Proto.Utxorpc.V1.Sync.Sync_Fields.maybe'raw' @:: Lens' AnyChainBlock (Prelude.Maybe Data.ByteString.ByteString)@
         * 'Proto.Utxorpc.V1.Sync.Sync_Fields.raw' @:: Lens' AnyChainBlock Data.ByteString.ByteString@
         * 'Proto.Utxorpc.V1.Sync.Sync_Fields.maybe'cardano' @:: Lens' AnyChainBlock (Prelude.Maybe Proto.Utxorpc.V1.Cardano.Cardano.Block)@
         * 'Proto.Utxorpc.V1.Sync.Sync_Fields.cardano' @:: Lens' AnyChainBlock Proto.Utxorpc.V1.Cardano.Cardano.Block@ -}
data AnyChainBlock
...
data AnyChainBlock'Chain
  = AnyChainBlock'Raw !Data.ByteString.ByteString |
    AnyChainBlock'Cardano !Proto.Utxorpc.V1.Cardano.Cardano.Block
...
instance Data.ProtoLens.Field.HasField AnyChainBlock "maybe'cardano" (Prelude.Maybe Proto.Utxorpc.V1.Cardano.Cardano.Block) where
  fieldOf _
    = (Prelude..)
        (Lens.Family2.Unchecked.lens
           _AnyChainBlock'chain
...
instance Data.ProtoLens.Field.HasField AnyChainBlock "cardano" Proto.Utxorpc.V1.Cardano.Cardano.Block where
  fieldOf _
    = (Prelude..)
        (Lens.Family2.Unchecked.lens
           _AnyChainBlock'chain
...
instance Data.ProtoLens.Message AnyChainBlock where
  messageName _ = Data.Text.pack "utxorpc.v1.sync.AnyChainBlock"
  packedMessageDescriptor _
    = "\n\
      \\rAnyChainBlock\DC2\DC2\n\
      \\ETXraw\CAN\SOH \SOH(\fH\NULR\ETXraw\DC25\n\
      \\acardano\CAN\STX \SOH(\v2\EM.utxorpc.v1.cardano.BlockH\NULR\acardanoB\a\n\
      \\ENQchain"
        ...
        cardano__field_descriptor
          = Data.ProtoLens.FieldDescriptor
              ...
              (Data.ProtoLens.MessageField Data.ProtoLens.MessageType ::
                 Data.ProtoLens.FieldTypeDescriptor Proto.Utxorpc.V1.Cardano.Cardano.Block)
              (Data.ProtoLens.OptionalField
...
_AnyChainBlock'Cardano ::
  Data.ProtoLens.Prism.Prism' AnyChainBlock'Chain Proto.Utxorpc.V1.Cardano.Cardano.Block
_AnyChainBlock'Cardano
  = Data.ProtoLens.Prism.prism'
...
{- | Fields :
         ...
         * 'Proto.Utxorpc.V1.Sync.Sync_Fields.index' @:: Lens' BlockRef Data.Word.Word64@
         * 'Proto.Utxorpc.V1.Sync.Sync_Fields.hash' @:: Lens' BlockRef Data.ByteString.ByteString@ -}
data BlockRef
...
instance Data.ProtoLens.Message BlockRef where
  messageName _ = Data.Text.pack "utxorpc.v1.sync.BlockRef"
  packedMessageDescriptor _
    = "\n\
      \\bBlockRef\DC2\DC4\n\
...
{- | Fields :
         ...
         * 'Proto.Utxorpc.V1.Sync.Sync_Fields.startToken' @:: Lens' DumpHistoryRequest BlockRef@
         * 'Proto.Utxorpc.V1.Sync.Sync_Fields.maybe'startToken' @:: Lens' DumpHistoryRequest (Prelude.Maybe BlockRef)@
         * 'Proto.Utxorpc.V1.Sync.Sync_Fields.maxItems' @:: Lens' DumpHistoryRequest Data.Word.Word32@
         * 'Proto.Utxorpc.V1.Sync.Sync_Fields.fieldMask' @:: Lens' DumpHistoryRequest Proto.Google.Protobuf.FieldMask.FieldMask@
         * 'Proto.Utxorpc.V1.Sync.Sync_Fields.maybe'fieldMask' @:: Lens' DumpHistoryRequest (Prelude.Maybe Proto.Google.Protobuf.FieldMask.FieldMask)@ -}
...
instance Data.ProtoLens.Message DumpHistoryRequest where
  messageName _ = Data.Text.pack "utxorpc.v1.sync.DumpHistoryRequest"
  packedMessageDescriptor _
    = "\n\
      \\DC2DumpHistoryRequest\DC2:\n\
      \\vstart_token\CAN\STX \SOH(\v2\EM.utxorpc.v1.sync.BlockRefR\n\
      \startToken\DC2\ESC\n\
...
{- | Fields :
         ...
         * 'Proto.Utxorpc.V1.Sync.Sync_Fields.block' @:: Lens' DumpHistoryResponse [AnyChainBlock]@
         * 'Proto.Utxorpc.V1.Sync.Sync_Fields.vec'block' @:: Lens' DumpHistoryResponse (Data.Vector.Vector AnyChainBlock)@
         * 'Proto.Utxorpc.V1.Sync.Sync_Fields.nextToken' @:: Lens' DumpHistoryResponse BlockRef@
         * 'Proto.Utxorpc.V1.Sync.Sync_Fields.maybe'nextToken' @:: Lens' DumpHistoryResponse (Prelude.Maybe BlockRef)@ -}
...
instance Data.ProtoLens.Message DumpHistoryResponse where
  messageName _
    = Data.Text.pack "utxorpc.v1.sync.DumpHistoryResponse"
  packedMessageDescriptor _
    = "\n\
      \\DC3DumpHistoryResponse\DC24\n\
      \\ENQblock\CAN\SOH \ETX(\v2\RS.utxorpc.v1.sync.AnyChainBlockR\ENQblock\DC28\n\
      \\n\
      \next_token\CAN\STX \SOH(\v2\EM.utxorpc.v1.sync.BlockRefR\tnextToken"
  packedFileDescriptor _ = packedFileDescriptor
  fieldsByTag
    = let
...
{- | Fields :
         ...
         * 'Proto.Utxorpc.V1.Sync.Sync_Fields.ref' @:: Lens' FetchBlockRequest [BlockRef]@
         * 'Proto.Utxorpc.V1.Sync.Sync_Fields.vec'ref' @:: Lens' FetchBlockRequest (Data.Vector.Vector BlockRef)@
         * 'Proto.Utxorpc.V1.Sync.Sync_Fields.fieldMask' @:: Lens' FetchBlockRequest Proto.Google.Protobuf.FieldMask.FieldMask@
         * 'Proto.Utxorpc.V1.Sync.Sync_Fields.maybe'fieldMask' @:: Lens' FetchBlockRequest (Prelude.Maybe Proto.Google.Protobuf.FieldMask.FieldMask)@ -}
...
instance Data.ProtoLens.Message FetchBlockRequest where
  messageName _ = Data.Text.pack "utxorpc.v1.sync.FetchBlockRequest"
  packedMessageDescriptor _
    = "\n\
      \\DC1FetchBlockRequest\DC2+\n\
      \\ETXref\CAN\SOH \ETX(\v2\EM.utxorpc.v1.sync.BlockRefR\ETXref\DC29\n\
      \\n\
...
{- | Fields :
         ...
         * 'Proto.Utxorpc.V1.Sync.Sync_Fields.block' @:: Lens' FetchBlockResponse [AnyChainBlock]@
         * 'Proto.Utxorpc.V1.Sync.Sync_Fields.vec'block' @:: Lens' FetchBlockResponse (Data.Vector.Vector AnyChainBlock)@ -}
...
instance Data.ProtoLens.Message FetchBlockResponse where
  messageName _ = Data.Text.pack "utxorpc.v1.sync.FetchBlockResponse"
  packedMessageDescriptor _
    = "\n\
      \\DC2FetchBlockResponse\DC24\n\
      \\ENQblock\CAN\SOH \ETX(\v2\RS.utxorpc.v1.sync.AnyChainBlockR\ENQblock"
  packedFileDescriptor _ = packedFileDescriptor
  fieldsByTag
    = let
        block__field_descriptor
...
{- | Fields :
         ...
         * 'Proto.Utxorpc.V1.Sync.Sync_Fields.intersect' @:: Lens' FollowTipRequest [BlockRef]@
         * 'Proto.Utxorpc.V1.Sync.Sync_Fields.vec'intersect' @:: Lens' FollowTipRequest (Data.Vector.Vector BlockRef)@ -}
...
instance Data.ProtoLens.Message FollowTipRequest where
  messageName _ = Data.Text.pack "utxorpc.v1.sync.FollowTipRequest"
  packedMessageDescriptor _
    = "\n\
      \\DLEFollowTipRequest\DC27\n\
      \\tintersect\CAN\SOH \ETX(\v2\EM.utxorpc.v1.sync.BlockRefR\tintersect"
  packedFileDescriptor _ = packedFileDescriptor
  fieldsByTag
    = let
...
{- | Fields :
         ...
         * 'Proto.Utxorpc.V1.Sync.Sync_Fields.maybe'action' @:: Lens' FollowTipResponse (Prelude.Maybe FollowTipResponse'Action)@
         * 'Proto.Utxorpc.V1.Sync.Sync_Fields.maybe'apply' @:: Lens' FollowTipResponse (Prelude.Maybe AnyChainBlock)@
         * 'Proto.Utxorpc.V1.Sync.Sync_Fields.apply' @:: Lens' FollowTipResponse AnyChainBlock@
         * 'Proto.Utxorpc.V1.Sync.Sync_Fields.maybe'undo' @:: Lens' FollowTipResponse (Prelude.Maybe AnyChainBlock)@
         * 'Proto.Utxorpc.V1.Sync.Sync_Fields.undo' @:: Lens' FollowTipResponse AnyChainBlock@
         * 'Proto.Utxorpc.V1.Sync.Sync_Fields.maybe'reset' @:: Lens' FollowTipResponse (Prelude.Maybe BlockRef)@
         * 'Proto.Utxorpc.V1.Sync.Sync_Fields.reset' @:: Lens' FollowTipResponse BlockRef@ -}
...
instance Data.ProtoLens.Message FollowTipResponse where
  messageName _ = Data.Text.pack "utxorpc.v1.sync.FollowTipResponse"
  packedMessageDescriptor _
    = "\n\
      \\DC1FollowTipResponse\DC26\n\
      \\ENQapply\CAN\SOH \SOH(\v2\RS.utxorpc.v1.sync.AnyChainBlockH\NULR\ENQapply\DC24\n\
      \\EOTundo\CAN\STX \SOH(\v2\RS.utxorpc.v1.sync.AnyChainBlockH\NULR\EOTundo\DC21\n\
      \\ENQreset\CAN\ETX \SOH(\v2\EM.utxorpc.v1.sync.BlockRefH\NULR\ENQresetB\b\n\
      \\ACKaction"
  packedFileDescriptor _ = packedFileDescriptor
  fieldsByTag
    = let
...
instance Data.ProtoLens.Service.Types.Service ChainSyncService where
  ...
  type ServicePackage ChainSyncService = "utxorpc.v1.sync"
  ...
  packedServiceDescriptor _
    = "\n\
      ...
      \\n\
      \FetchBlock\DC2\".utxorpc.v1.sync.FetchBlockRequest\SUB#.utxorpc.v1.sync.FetchBlockResponse\DC2X\n\
      \\vDumpHistory\DC2#.utxorpc.v1.sync.DumpHistoryRequest\SUB$.utxorpc.v1.sync.DumpHistoryResponse\DC2T\n\
      \\tFollowTip\DC2!.utxorpc.v1.sync.FollowTipRequest\SUB\".utxorpc.v1.sync.FollowTipResponse0\SOH"
...
packedFileDescriptor
  = "\n\
    \\SUButxorpc/v1/sync/sync.proto\DC2\SIutxorpc.v1.sync\SUB google/protobuf/field_mask.proto\SUB utxorpc/v1/cardano/cardano.proto\"4\n\
    \\bBlockRef\DC2\DC4\n\
    \\ENQindex\CAN\SOH \SOH(\EOTR\ENQindex\DC2\DC2\n\
    ...
    \\DC2FetchBlockResponse\DC24\n\
    \\ENQblock\CAN\SOH \ETX(\v2\RS.utxorpc.v1.sync.AnyChainBlockR\ENQblock\"\168\SOH\n\
    \\DC2DumpHistoryRequest\DC2:\n\
    \\vstart_token\CAN\STX \SOH(\v2\EM.utxorpc.v1.sync.BlockRefR\n\
    \startToken\DC2\ESC\n\
    \\tmax_items\CAN\ETX \SOH(\rR\bmaxItems\DC29\n\
    ...
    \\ENQblock\CAN\SOH \ETX(\v2\RS.utxorpc.v1.sync.AnyChainBlockR\ENQblock\DC28\n\
    \\n\
    \next_token\CAN\STX \SOH(\v2\EM.utxorpc.v1.sync.BlockRefR\tnextToken\"K\n\
    \\DLEFollowTipRequest\DC27\n\
    \\tintersect\CAN\SOH \ETX(\v2\EM.utxorpc.v1.sync.BlockRefR\tintersect\"\190\SOH\n\
    \\DC1FollowTipResponse\DC26\n\
    \\ENQapply\CAN\SOH \SOH(\v2\RS.utxorpc.v1.sync.AnyChainBlockH\NULR\ENQapply\DC24\n\
    \\EOTundo\CAN\STX \SOH(\v2\RS.utxorpc.v1.sync.AnyChainBlockH\NULR\EOTundo\DC21\n\
    \\ENQreset\CAN\ETX \SOH(\v2\EM.utxorpc.v1.sync.BlockRefH\NULR\ENQresetB\b\n\
    ...
    \FetchBlock\DC2\".utxorpc.v1.sync.FetchBlockRequest\SUB#.utxorpc.v1.sync.FetchBlockResponse\DC2X\n\
    \\vDumpHistory\DC2#.utxorpc.v1.sync.DumpHistoryRequest\SUB$.utxorpc.v1.sync.DumpHistoryResponse\DC2T\n\
    \\tFollowTip\DC2!.utxorpc.v1.sync.FollowTipRequest\SUB\".utxorpc.v1.sync.FollowTipResponse0\SOHB\174\SOH\n\
    \\DC3com.utxorpc.v1.syncB\tSyncProtoP\SOHZ.github.com/utxorpc/spec/gen/go/utxorpc/v1/sync\162\STX\ETXUVS\170\STX\SIUtxorpc.V1.Sync\202\STX\SIUtxorpc\\V1\\Sync\226\STX\ESCUtxorpc\\V1\\Sync\\GPBMetadata\234\STX\DC1Utxorpc::V1::SyncJ\191\DC3\n\
