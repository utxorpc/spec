...
module Proto.Utxorpc.V1.Watch.Watch (
...
{- | Fields :
         ...
         * 'Proto.Utxorpc.V1.Watch.Watch_Fields.maybe'chain' @:: Lens' AnyChainTx (Prelude.Maybe AnyChainTx'Chain)@
         * 'Proto.Utxorpc.V1.Watch.Watch_Fields.maybe'cardano' @:: Lens' AnyChainTx (Prelude.Maybe Proto.Utxorpc.V1.Cardano.Cardano.Tx)@
         * 'Proto.Utxorpc.V1.Watch.Watch_Fields.cardano' @:: Lens' AnyChainTx Proto.Utxorpc.V1.Cardano.Cardano.Tx@ -}
data AnyChainTx
...
data AnyChainTx'Chain
  = AnyChainTx'Cardano !Proto.Utxorpc.V1.Cardano.Cardano.Tx
...
instance Data.ProtoLens.Field.HasField AnyChainTx "maybe'chain" (Prelude.Maybe AnyChainTx'Chain) where
  fieldOf _
    = (Prelude..)
        ...
        Prelude.id
instance Data.ProtoLens.Field.HasField AnyChainTx "maybe'cardano" (Prelude.Maybe Proto.Utxorpc.V1.Cardano.Cardano.Tx) where
  fieldOf _
    = (Prelude..)
        (Lens.Family2.Unchecked.lens
           _AnyChainTx'chain (\ x__ y__ -> x__ {_AnyChainTx'chain = y__}))
...
instance Data.ProtoLens.Field.HasField AnyChainTx "cardano" Proto.Utxorpc.V1.Cardano.Cardano.Tx where
  fieldOf _
    = (Prelude..)
        (Lens.Family2.Unchecked.lens
           _AnyChainTx'chain (\ x__ y__ -> x__ {_AnyChainTx'chain = y__}))
...
instance Data.ProtoLens.Message AnyChainTx where
  messageName _ = Data.Text.pack "utxorpc.v1.watch.AnyChainTx"
  packedMessageDescriptor _
    = "\n\
      \\n\
      \AnyChainTx\DC22\n\
      \\acardano\CAN\SOH \SOH(\v2\SYN.utxorpc.v1.cardano.TxH\NULR\acardanoB\a\n\
      \\ENQchain"
        ...
        cardano__field_descriptor
          = Data.ProtoLens.FieldDescriptor
              ...
              (Data.ProtoLens.MessageField Data.ProtoLens.MessageType ::
                 Data.ProtoLens.FieldTypeDescriptor Proto.Utxorpc.V1.Cardano.Cardano.Tx)
...
_AnyChainTx'Cardano ::
  Data.ProtoLens.Prism.Prism' AnyChainTx'Chain Proto.Utxorpc.V1.Cardano.Cardano.Tx
_AnyChainTx'Cardano
...
{- | Fields :
         ...
         * 'Proto.Utxorpc.V1.Watch.Watch_Fields.maybe'chain' @:: Lens' AnyChainTxPattern (Prelude.Maybe AnyChainTxPattern'Chain)@
         * 'Proto.Utxorpc.V1.Watch.Watch_Fields.maybe'cardano' @:: Lens' AnyChainTxPattern (Prelude.Maybe Proto.Utxorpc.V1.Cardano.Cardano.TxPattern)@
         * 'Proto.Utxorpc.V1.Watch.Watch_Fields.cardano' @:: Lens' AnyChainTxPattern Proto.Utxorpc.V1.Cardano.Cardano.TxPattern@ -}
...
instance Data.ProtoLens.Message AnyChainTxPattern where
  messageName _ = Data.Text.pack "utxorpc.v1.watch.AnyChainTxPattern"
  packedMessageDescriptor _
    = "\n\
...
{- | Fields :
         ...
         * 'Proto.Utxorpc.V1.Watch.Watch_Fields.match' @:: Lens' TxPredicate AnyChainTxPattern@
         * 'Proto.Utxorpc.V1.Watch.Watch_Fields.maybe'match' @:: Lens' TxPredicate (Prelude.Maybe AnyChainTxPattern)@
         * 'Proto.Utxorpc.V1.Watch.Watch_Fields.not' @:: Lens' TxPredicate [TxPredicate]@
         * 'Proto.Utxorpc.V1.Watch.Watch_Fields.vec'not' @:: Lens' TxPredicate (Data.Vector.Vector TxPredicate)@
         * 'Proto.Utxorpc.V1.Watch.Watch_Fields.allOf' @:: Lens' TxPredicate [TxPredicate]@
         * 'Proto.Utxorpc.V1.Watch.Watch_Fields.vec'allOf' @:: Lens' TxPredicate (Data.Vector.Vector TxPredicate)@
         * 'Proto.Utxorpc.V1.Watch.Watch_Fields.anyOf' @:: Lens' TxPredicate [TxPredicate]@
         * 'Proto.Utxorpc.V1.Watch.Watch_Fields.vec'anyOf' @:: Lens' TxPredicate (Data.Vector.Vector TxPredicate)@ -}
data TxPredicate
...
instance Data.ProtoLens.Message TxPredicate where
  messageName _ = Data.Text.pack "utxorpc.v1.watch.TxPredicate"
  packedMessageDescriptor _
    = "\n\
      \\vTxPredicate\DC29\n\
      \\ENQmatch\CAN\SOH \SOH(\v2#.utxorpc.v1.watch.AnyChainTxPatternR\ENQmatch\DC2/\n\
      \\ETXnot\CAN\STX \ETX(\v2\GS.utxorpc.v1.watch.TxPredicateR\ETXnot\DC24\n\
      \\ACKall_of\CAN\ETX \ETX(\v2\GS.utxorpc.v1.watch.TxPredicateR\ENQallOf\DC24\n\
      \\ACKany_of\CAN\EOT \ETX(\v2\GS.utxorpc.v1.watch.TxPredicateR\ENQanyOf"
  packedFileDescriptor _ = packedFileDescriptor
  fieldsByTag
    = let
...
{- | Fields :
         ...
         * 'Proto.Utxorpc.V1.Watch.Watch_Fields.predicate' @:: Lens' WatchTxRequest TxPredicate@
         * 'Proto.Utxorpc.V1.Watch.Watch_Fields.maybe'predicate' @:: Lens' WatchTxRequest (Prelude.Maybe TxPredicate)@
         * 'Proto.Utxorpc.V1.Watch.Watch_Fields.fieldMask' @:: Lens' WatchTxRequest Proto.Google.Protobuf.FieldMask.FieldMask@
         * 'Proto.Utxorpc.V1.Watch.Watch_Fields.maybe'fieldMask' @:: Lens' WatchTxRequest (Prelude.Maybe Proto.Google.Protobuf.FieldMask.FieldMask)@ -}
data WatchTxRequest
...
instance Data.ProtoLens.Message WatchTxRequest where
  messageName _ = Data.Text.pack "utxorpc.v1.watch.WatchTxRequest"
  packedMessageDescriptor _
    = "\n\
      \\SOWatchTxRequest\DC2;\n\
      \\tpredicate\CAN\SOH \SOH(\v2\GS.utxorpc.v1.watch.TxPredicateR\tpredicate\DC29\n\
      \\n\
...
{- | Fields :
         ...
         * 'Proto.Utxorpc.V1.Watch.Watch_Fields.maybe'action' @:: Lens' WatchTxResponse (Prelude.Maybe WatchTxResponse'Action)@
         * 'Proto.Utxorpc.V1.Watch.Watch_Fields.maybe'apply' @:: Lens' WatchTxResponse (Prelude.Maybe AnyChainTx)@
         * 'Proto.Utxorpc.V1.Watch.Watch_Fields.apply' @:: Lens' WatchTxResponse AnyChainTx@
         * 'Proto.Utxorpc.V1.Watch.Watch_Fields.maybe'undo' @:: Lens' WatchTxResponse (Prelude.Maybe AnyChainTx)@
         * 'Proto.Utxorpc.V1.Watch.Watch_Fields.undo' @:: Lens' WatchTxResponse AnyChainTx@ -}
...
instance Data.ProtoLens.Message WatchTxResponse where
  messageName _ = Data.Text.pack "utxorpc.v1.watch.WatchTxResponse"
  packedMessageDescriptor _
    = "\n\
      \\SIWatchTxResponse\DC24\n\
      \\ENQapply\CAN\SOH \SOH(\v2\FS.utxorpc.v1.watch.AnyChainTxH\NULR\ENQapply\DC22\n\
      \\EOTundo\CAN\STX \SOH(\v2\FS.utxorpc.v1.watch.AnyChainTxH\NULR\EOTundoB\b\n\
      \\ACKaction"
  packedFileDescriptor _ = packedFileDescriptor
  fieldsByTag
    = let
...
instance Data.ProtoLens.Service.Types.Service WatchService where
  ...
  type ServicePackage WatchService = "utxorpc.v1.watch"
  type ServiceMethods WatchService = '["watchTx"]
  packedServiceDescriptor _
    = "\n\
      \\fWatchService\DC2P\n\
      \\aWatchTx\DC2 .utxorpc.v1.watch.WatchTxRequest\SUB!.utxorpc.v1.watch.WatchTxResponse0\SOH"
...
packedFileDescriptor
  = "\n\
    \\FSutxorpc/v1/watch/watch.proto\DC2\DLEutxorpc.v1.watch\SUB google/protobuf/field_mask.proto\SUB utxorpc/v1/cardano/cardano.proto\"W\n\
    \\DC1AnyChainTxPattern\DC29\n\
    \\acardano\CAN\SOH \SOH(\v2\GS.utxorpc.v1.cardano.TxPatternH\NULR\acardanoB\a\n\
    \\ENQchain\"\229\SOH\n\
    \\vTxPredicate\DC29\n\
    ...
    \\ETXnot\CAN\STX \ETX(\v2\GS.utxorpc.v1.watch.TxPredicateR\ETXnot\DC24\n\
    \\ACKall_of\CAN\ETX \ETX(\v2\GS.utxorpc.v1.watch.TxPredicateR\ENQallOf\DC24\n\
    \\ACKany_of\CAN\EOT \ETX(\v2\GS.utxorpc.v1.watch.TxPredicateR\ENQanyOf\"\136\SOH\n\
    \\SOWatchTxRequest\DC2;\n\
    \\tpredicate\CAN\SOH \SOH(\v2\GS.utxorpc.v1.watch.TxPredicateR\tpredicate\DC29\n\
    \\n\
    ...
    \\ACKaction2`\n\
    \\fWatchService\DC2P\n\
    \\aWatchTx\DC2 .utxorpc.v1.watch.WatchTxRequest\SUB!.utxorpc.v1.watch.WatchTxResponse0\SOHB\181\SOH\n\
    \\DC4com.utxorpc.v1.watchB\n\
    \WatchProtoP\SOHZ/github.com/utxorpc/spec/gen/go/utxorpc/v1/watch\162\STX\ETXUVW\170\STX\DLEUtxorpc.V1.Watch\202\STX\DLEUtxorpc\\V1\\Watch\226\STX\FSUtxorpc\\V1\\Watch\\GPBMetadata\234\STX\DC2Utxorpc::V1::WatchJ\150\SO\n\
