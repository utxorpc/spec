{- This file was auto-generated from utxorpc/v1/submit/submit.proto by the proto-lens-protoc program. -}
{-# LANGUAGE ScopedTypeVariables, DataKinds, TypeFamilies, UndecidableInstances, GeneralizedNewtypeDeriving, MultiParamTypeClasses, FlexibleContexts, FlexibleInstances, PatternSynonyms, MagicHash, NoImplicitPrelude, DataKinds, BangPatterns, TypeApplications, OverloadedStrings, DerivingStrategies#-}
{-# OPTIONS_GHC -Wno-unused-imports#-}
{-# OPTIONS_GHC -Wno-duplicate-exports#-}
{-# OPTIONS_GHC -Wno-dodgy-exports#-}
module Proto.Utxorpc.V1.Submit.Submit (
...
{- | Fields :
         ...
         * 'Proto.Utxorpc.V1.Submit.Submit_Fields.maybe'type'' @:: Lens' AnyChainTx (Prelude.Maybe AnyChainTx'Type)@
         * 'Proto.Utxorpc.V1.Submit.Submit_Fields.maybe'raw' @:: Lens' AnyChainTx (Prelude.Maybe Data.ByteString.ByteString)@
         * 'Proto.Utxorpc.V1.Submit.Submit_Fields.raw' @:: Lens' AnyChainTx Data.ByteString.ByteString@ -}
data AnyChainTx
...
instance Data.ProtoLens.Message AnyChainTx where
  messageName _ = Data.Text.pack "utxorpc.v1.submit.AnyChainTx"
...
{- | Fields :
         ...
         * 'Proto.Utxorpc.V1.Submit.Submit_Fields.maybe'chain' @:: Lens' AnyChainTxPattern (Prelude.Maybe AnyChainTxPattern'Chain)@
         * 'Proto.Utxorpc.V1.Submit.Submit_Fields.maybe'cardano' @:: Lens' AnyChainTxPattern (Prelude.Maybe Proto.Utxorpc.V1.Cardano.Cardano.TxPattern)@
         * 'Proto.Utxorpc.V1.Submit.Submit_Fields.cardano' @:: Lens' AnyChainTxPattern Proto.Utxorpc.V1.Cardano.Cardano.TxPattern@ -}
...
data AnyChainTxPattern'Chain
  = AnyChainTxPattern'Cardano !Proto.Utxorpc.V1.Cardano.Cardano.TxPattern
  deriving stock (Prelude.Show, Prelude.Eq, Prelude.Ord)
instance Data.ProtoLens.Field.HasField AnyChainTxPattern "maybe'chain" (Prelude.Maybe AnyChainTxPattern'Chain) where
  fieldOf _
    = (Prelude..)
        ...
        Prelude.id
instance Data.ProtoLens.Field.HasField AnyChainTxPattern "maybe'cardano" (Prelude.Maybe Proto.Utxorpc.V1.Cardano.Cardano.TxPattern) where
  fieldOf _
    = (Prelude..)
        (Lens.Family2.Unchecked.lens
           _AnyChainTxPattern'chain
...
instance Data.ProtoLens.Field.HasField AnyChainTxPattern "cardano" Proto.Utxorpc.V1.Cardano.Cardano.TxPattern where
  fieldOf _
    = (Prelude..)
        (Lens.Family2.Unchecked.lens
           _AnyChainTxPattern'chain
...
instance Data.ProtoLens.Message AnyChainTxPattern where
  messageName _
    = Data.Text.pack "utxorpc.v1.submit.AnyChainTxPattern"
  packedMessageDescriptor _
    = "\n\
      \\DC1AnyChainTxPattern\DC29\n\
      \\acardano\CAN\SOH \SOH(\v2\GS.utxorpc.v1.cardano.TxPatternH\NULR\acardanoB\a\n\
      \\ENQchain"
  packedFileDescriptor _ = packedFileDescriptor
  fieldsByTag
    = let
        cardano__field_descriptor
          = Data.ProtoLens.FieldDescriptor
              ...
              (Data.ProtoLens.MessageField Data.ProtoLens.MessageType ::
                 Data.ProtoLens.FieldTypeDescriptor Proto.Utxorpc.V1.Cardano.Cardano.TxPattern)
              (Data.ProtoLens.OptionalField
...
_AnyChainTxPattern'Cardano ::
  Data.ProtoLens.Prism.Prism' AnyChainTxPattern'Chain Proto.Utxorpc.V1.Cardano.Cardano.TxPattern
_AnyChainTxPattern'Cardano
  = Data.ProtoLens.Prism.prism'
...
{- | Fields :
         ...
         * 'Proto.Utxorpc.V1.Submit.Submit_Fields.txs' @:: Lens' ReadMempoolRequest [TxInMempool]@
         * 'Proto.Utxorpc.V1.Submit.Submit_Fields.vec'txs' @:: Lens' ReadMempoolRequest (Data.Vector.Vector TxInMempool)@ -}
...
instance Data.ProtoLens.Message ReadMempoolRequest where
  messageName _
    = Data.Text.pack "utxorpc.v1.submit.ReadMempoolRequest"
  packedMessageDescriptor _
    = "\n\
      \\DC2ReadMempoolRequest\DC20\n\
      \\ETXtxs\CAN\SOH \ETX(\v2\RS.utxorpc.v1.submit.TxInMempoolR\ETXtxs"
  packedFileDescriptor _ = packedFileDescriptor
  fieldsByTag
    = let
...
{- | Fields :
         ...
         * 'Proto.Utxorpc.V1.Submit.Submit_Fields.stage' @:: Lens' ReadMempoolResponse [Stage]@
         * 'Proto.Utxorpc.V1.Submit.Submit_Fields.vec'stage' @:: Lens' ReadMempoolResponse (Data.Vector.Vector Stage)@ -}
...
instance Data.ProtoLens.Message ReadMempoolResponse where
  messageName _
    = Data.Text.pack "utxorpc.v1.submit.ReadMempoolResponse"
  packedMessageDescriptor _
    = "\n\
      \\DC3ReadMempoolResponse\DC2.\n\
      \\ENQstage\CAN\SOH \ETX(\SO2\CAN.utxorpc.v1.submit.StageR\ENQstage"
  packedFileDescriptor _ = packedFileDescriptor
  fieldsByTag
    = let
...
{- | Fields :
         ...
         * 'Proto.Utxorpc.V1.Submit.Submit_Fields.tx' @:: Lens' SubmitTxRequest [AnyChainTx]@
         * 'Proto.Utxorpc.V1.Submit.Submit_Fields.vec'tx' @:: Lens' SubmitTxRequest (Data.Vector.Vector AnyChainTx)@ -}
...
instance Data.ProtoLens.Message SubmitTxRequest where
  messageName _ = Data.Text.pack "utxorpc.v1.submit.SubmitTxRequest"
  packedMessageDescriptor _
    = "\n\
      \\SISubmitTxRequest\DC2-\n\
      \\STXtx\CAN\SOH \ETX(\v2\GS.utxorpc.v1.submit.AnyChainTxR\STXtx"
  packedFileDescriptor _ = packedFileDescriptor
  fieldsByTag
    = let
...
{- | Fields :
         ...
         * 'Proto.Utxorpc.V1.Submit.Submit_Fields.ref' @:: Lens' SubmitTxResponse [Data.ByteString.ByteString]@
         * 'Proto.Utxorpc.V1.Submit.Submit_Fields.vec'ref' @:: Lens' SubmitTxResponse (Data.Vector.Vector Data.ByteString.ByteString)@ -}
...
instance Data.ProtoLens.Message SubmitTxResponse where
  messageName _ = Data.Text.pack "utxorpc.v1.submit.SubmitTxResponse"
  packedMessageDescriptor _
    = "\n\
...
{- | Fields :
         ...
         * 'Proto.Utxorpc.V1.Submit.Submit_Fields.tx' @:: Lens' TxInMempool AnyChainTx@
         * 'Proto.Utxorpc.V1.Submit.Submit_Fields.maybe'tx' @:: Lens' TxInMempool (Prelude.Maybe AnyChainTx)@
         * 'Proto.Utxorpc.V1.Submit.Submit_Fields.stage' @:: Lens' TxInMempool Stage@ -}
data TxInMempool
...
instance Data.ProtoLens.Message TxInMempool where
  messageName _ = Data.Text.pack "utxorpc.v1.submit.TxInMempool"
  packedMessageDescriptor _
    = "\n\
      \\vTxInMempool\DC2-\n\
      \\STXtx\CAN\SOH \SOH(\v2\GS.utxorpc.v1.submit.AnyChainTxR\STXtx\DC2.\n\
      \\ENQstage\CAN\STX \SOH(\SO2\CAN.utxorpc.v1.submit.StageR\ENQstage"
  packedFileDescriptor _ = packedFileDescriptor
  fieldsByTag
    = let
        tx__field_descriptor
...
{- | Fields :
         ...
         * 'Proto.Utxorpc.V1.Submit.Submit_Fields.match' @:: Lens' TxPredicate AnyChainTxPattern@
         * 'Proto.Utxorpc.V1.Submit.Submit_Fields.maybe'match' @:: Lens' TxPredicate (Prelude.Maybe AnyChainTxPattern)@
         * 'Proto.Utxorpc.V1.Submit.Submit_Fields.not' @:: Lens' TxPredicate [TxPredicate]@
         * 'Proto.Utxorpc.V1.Submit.Submit_Fields.vec'not' @:: Lens' TxPredicate (Data.Vector.Vector TxPredicate)@
         * 'Proto.Utxorpc.V1.Submit.Submit_Fields.allOf' @:: Lens' TxPredicate [TxPredicate]@
         * 'Proto.Utxorpc.V1.Submit.Submit_Fields.vec'allOf' @:: Lens' TxPredicate (Data.Vector.Vector TxPredicate)@
         * 'Proto.Utxorpc.V1.Submit.Submit_Fields.anyOf' @:: Lens' TxPredicate [TxPredicate]@
         * 'Proto.Utxorpc.V1.Submit.Submit_Fields.vec'anyOf' @:: Lens' TxPredicate (Data.Vector.Vector TxPredicate)@ -}
data TxPredicate
...
instance Data.ProtoLens.Message TxPredicate where
  messageName _ = Data.Text.pack "utxorpc.v1.submit.TxPredicate"
  packedMessageDescriptor _
    = "\n\
      \\vTxPredicate\DC2:\n\
      \\ENQmatch\CAN\SOH \SOH(\v2$.utxorpc.v1.submit.AnyChainTxPatternR\ENQmatch\DC20\n\
      \\ETXnot\CAN\STX \ETX(\v2\RS.utxorpc.v1.submit.TxPredicateR\ETXnot\DC25\n\
      \\ACKall_of\CAN\ETX \ETX(\v2\RS.utxorpc.v1.submit.TxPredicateR\ENQallOf\DC25\n\
      \\ACKany_of\CAN\EOT \ETX(\v2\RS.utxorpc.v1.submit.TxPredicateR\ENQanyOf"
  packedFileDescriptor _ = packedFileDescriptor
  fieldsByTag
    = let
...
{- | Fields :
         ...
         * 'Proto.Utxorpc.V1.Submit.Submit_Fields.ref' @:: Lens' WaitForTxRequest [Data.ByteString.ByteString]@
         * 'Proto.Utxorpc.V1.Submit.Submit_Fields.vec'ref' @:: Lens' WaitForTxRequest (Data.Vector.Vector Data.ByteString.ByteString)@ -}
...
instance Data.ProtoLens.Message WaitForTxRequest where
  messageName _ = Data.Text.pack "utxorpc.v1.submit.WaitForTxRequest"
  packedMessageDescriptor _
    = "\n\
...
{- | Fields :
         ...
         * 'Proto.Utxorpc.V1.Submit.Submit_Fields.ref' @:: Lens' WaitForTxResponse Data.ByteString.ByteString@
         * 'Proto.Utxorpc.V1.Submit.Submit_Fields.stage' @:: Lens' WaitForTxResponse Stage@ -}
...
instance Data.ProtoLens.Message WaitForTxResponse where
  messageName _
    = Data.Text.pack "utxorpc.v1.submit.WaitForTxResponse"
  packedMessageDescriptor _
    = "\n\
...
{- | Fields :
         ...
         * 'Proto.Utxorpc.V1.Submit.Submit_Fields.predicate' @:: Lens' WatchMempoolRequest TxPredicate@
         * 'Proto.Utxorpc.V1.Submit.Submit_Fields.maybe'predicate' @:: Lens' WatchMempoolRequest (Prelude.Maybe TxPredicate)@
         * 'Proto.Utxorpc.V1.Submit.Submit_Fields.fieldMask' @:: Lens' WatchMempoolRequest Proto.Google.Protobuf.FieldMask.FieldMask@
         * 'Proto.Utxorpc.V1.Submit.Submit_Fields.maybe'fieldMask' @:: Lens' WatchMempoolRequest (Prelude.Maybe Proto.Google.Protobuf.FieldMask.FieldMask)@ -}
...
instance Data.ProtoLens.Message WatchMempoolRequest where
  messageName _
    = Data.Text.pack "utxorpc.v1.submit.WatchMempoolRequest"
  packedMessageDescriptor _
    = "\n\
      \\DC3WatchMempoolRequest\DC2<\n\
      \\tpredicate\CAN\SOH \SOH(\v2\RS.utxorpc.v1.submit.TxPredicateR\tpredicate\DC29\n\
      \\n\
...
{- | Fields :
         ...
         * 'Proto.Utxorpc.V1.Submit.Submit_Fields.tx' @:: Lens' WatchMempoolResponse TxInMempool@
         * 'Proto.Utxorpc.V1.Submit.Submit_Fields.maybe'tx' @:: Lens' WatchMempoolResponse (Prelude.Maybe TxInMempool)@ -}
...
instance Data.ProtoLens.Message WatchMempoolResponse where
  messageName _
    = Data.Text.pack "utxorpc.v1.submit.WatchMempoolResponse"
  packedMessageDescriptor _
    = "\n\
      \\DC4WatchMempoolResponse\DC2.\n\
      \\STXtx\CAN\SOH \SOH(\v2\RS.utxorpc.v1.submit.TxInMempoolR\STXtx"
  packedFileDescriptor _ = packedFileDescriptor
  fieldsByTag
    = let
        tx__field_descriptor
...
instance Data.ProtoLens.Service.Types.Service SubmitService where
  ...
  type ServicePackage SubmitService = "utxorpc.v1.submit"
  ...
  packedServiceDescriptor _
    = "\n\
      \\rSubmitService\DC2S\n\
      \\bSubmitTx\DC2\".utxorpc.v1.submit.SubmitTxRequest\SUB#.utxorpc.v1.submit.SubmitTxResponse\DC2X\n\
      \\tWaitForTx\DC2#.utxorpc.v1.submit.WaitForTxRequest\SUB$.utxorpc.v1.submit.WaitForTxResponse0\SOH\DC2\\\n\
      \\vReadMempool\DC2%.utxorpc.v1.submit.ReadMempoolRequest\SUB&.utxorpc.v1.submit.ReadMempoolResponse\DC2a\n\
      \\fWatchMempool\DC2&.utxorpc.v1.submit.WatchMempoolRequest\SUB'.utxorpc.v1.submit.WatchMempoolResponse0\SOH"
...
packedFileDescriptor
  = "\n\
    \\RSutxorpc/v1/submit/submit.proto\DC2\DC1utxorpc.v1.submit\SUB google/protobuf/field_mask.proto\SUB utxorpc/v1/cardano/cardano.proto\"(\n\
    \\n\
    \AnyChainTx\DC2\DC2\n\
    \\ETXraw\CAN\SOH \SOH(\fH\NULR\ETXrawB\ACK\n\
    \\EOTtype\"@\n\
    ...
    \\vTxInMempool\DC2-\n\
    \\STXtx\CAN\SOH \SOH(\v2\GS.utxorpc.v1.submit.AnyChainTxR\STXtx\DC2.\n\
    \\ENQstage\CAN\STX \SOH(\SO2\CAN.utxorpc.v1.submit.StageR\ENQstage\"F\n\
    \\DC2ReadMempoolRequest\DC20\n\
    \\ETXtxs\CAN\SOH \ETX(\v2\RS.utxorpc.v1.submit.TxInMempoolR\ETXtxs\"E\n\
    \\DC3ReadMempoolResponse\DC2.\n\
    \\ENQstage\CAN\SOH \ETX(\SO2\CAN.utxorpc.v1.submit.StageR\ENQstage\"$\n\
    \\DLEWaitForTxRequest\DC2\DLE\n\
    ...
    \\DC1WaitForTxResponse\DC2\DLE\n\
    \\ETXref\CAN\SOH \SOH(\fR\ETXref\DC2.\n\
    \\ENQstage\CAN\STX \SOH(\SO2\CAN.utxorpc.v1.submit.StageR\ENQstage\"W\n\
    \\DC1AnyChainTxPattern\DC29\n\
    \\acardano\CAN\SOH \SOH(\v2\GS.utxorpc.v1.cardano.TxPatternH\NULR\acardanoB\a\n\
    \\ENQchain\"\233\SOH\n\
    \\vTxPredicate\DC2:\n\
    ...
    \\ETXnot\CAN\STX \ETX(\v2\RS.utxorpc.v1.submit.TxPredicateR\ETXnot\DC25\n\
    \\ACKall_of\CAN\ETX \ETX(\v2\RS.utxorpc.v1.submit.TxPredicateR\ENQallOf\DC25\n\
    \\ACKany_of\CAN\EOT \ETX(\v2\RS.utxorpc.v1.submit.TxPredicateR\ENQanyOf\"\142\SOH\n\
    \\DC3WatchMempoolRequest\DC2<\n\
    \\tpredicate\CAN\SOH \SOH(\v2\RS.utxorpc.v1.submit.TxPredicateR\tpredicate\DC29\n\
    \\n\
    \field_mask\CAN\STX \SOH(\v2\SUB.google.protobuf.FieldMaskR\tfieldMask\"F\n\
    \\DC4WatchMempoolResponse\DC2.\n\
    \\STXtx\CAN\SOH \SOH(\v2\RS.utxorpc.v1.submit.TxInMempoolR\STXtx*q\n\
    \\ENQStage\DC2\NAK\n\
    ...
    \\tWaitForTx\DC2#.utxorpc.v1.submit.WaitForTxRequest\SUB$.utxorpc.v1.submit.WaitForTxResponse0\SOH\DC2\\\n\
    \\vReadMempool\DC2%.utxorpc.v1.submit.ReadMempoolRequest\SUB&.utxorpc.v1.submit.ReadMempoolResponse\DC2a\n\
    \\fWatchMempool\DC2&.utxorpc.v1.submit.WatchMempoolRequest\SUB'.utxorpc.v1.submit.WatchMempoolResponse0\SOHB\188\SOH\n\
    \\NAKcom.utxorpc.v1.submitB\vSubmitProtoP\SOHZ0github.com/utxorpc/spec/gen/go/utxorpc/v1/submit\162\STX\ETXUVS\170\STX\DC1Utxorpc.V1.Submit\202\STX\DC1Utxorpc\\V1\\Submit\226\STX\GSUtxorpc\\V1\\Submit\\GPBMetadata\234\STX\DC3Utxorpc::V1::SubmitJ\203\US\n\
