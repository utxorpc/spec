...
module Proto.Utxorpc.V1.Build.Build (
...
{- | Fields :
         ...
         * 'Proto.Utxorpc.V1.Build.Build_Fields.maybe'chain' @:: Lens' AnyChainUtxo (Prelude.Maybe AnyChainUtxo'Chain)@
         * 'Proto.Utxorpc.V1.Build.Build_Fields.maybe'cardano' @:: Lens' AnyChainUtxo (Prelude.Maybe Proto.Utxorpc.V1.Cardano.Cardano.TxOutput)@
         * 'Proto.Utxorpc.V1.Build.Build_Fields.cardano' @:: Lens' AnyChainUtxo Proto.Utxorpc.V1.Cardano.Cardano.TxOutput@ -}
data AnyChainUtxo
...
data AnyChainUtxo'Chain
  = AnyChainUtxo'Cardano !Proto.Utxorpc.V1.Cardano.Cardano.TxOutput
...
instance Data.ProtoLens.Field.HasField AnyChainUtxo "maybe'chain" (Prelude.Maybe AnyChainUtxo'Chain) where
  fieldOf _
    = (Prelude..)
        ...
        Prelude.id
instance Data.ProtoLens.Field.HasField AnyChainUtxo "maybe'cardano" (Prelude.Maybe Proto.Utxorpc.V1.Cardano.Cardano.TxOutput) where
  fieldOf _
    = (Prelude..)
        (Lens.Family2.Unchecked.lens
           _AnyChainUtxo'chain (\ x__ y__ -> x__ {_AnyChainUtxo'chain = y__}))
...
instance Data.ProtoLens.Field.HasField AnyChainUtxo "cardano" Proto.Utxorpc.V1.Cardano.Cardano.TxOutput where
  fieldOf _
    = (Prelude..)
        (Lens.Family2.Unchecked.lens
           _AnyChainUtxo'chain (\ x__ y__ -> x__ {_AnyChainUtxo'chain = y__}))
...
instance Data.ProtoLens.Message AnyChainUtxo where
  messageName _ = Data.Text.pack "utxorpc.v1.build.AnyChainUtxo"
  packedMessageDescriptor _
    = "\n\
      \\fAnyChainUtxo\DC28\n\
      \\acardano\CAN\SOH \SOH(\v2\FS.utxorpc.v1.cardano.TxOutputH\NULR\acardanoB\a\n\
      \\ENQchain"
        ...
        cardano__field_descriptor
          = Data.ProtoLens.FieldDescriptor
              ...
              (Data.ProtoLens.MessageField Data.ProtoLens.MessageType ::
                 Data.ProtoLens.FieldTypeDescriptor Proto.Utxorpc.V1.Cardano.Cardano.TxOutput)
...
_AnyChainUtxo'Cardano ::
  Data.ProtoLens.Prism.Prism' AnyChainUtxo'Chain Proto.Utxorpc.V1.Cardano.Cardano.TxOutput
_AnyChainUtxo'Cardano
...
{- | Fields :
         ...
         * 'Proto.Utxorpc.V1.Build.Build_Fields.key' @:: Lens' ChainParam Data.Text.Text@
         * 'Proto.Utxorpc.V1.Build.Build_Fields.value' @:: Lens' ChainParam Data.ByteString.ByteString@ -}
data ChainParam
...
instance Data.ProtoLens.Message ChainParam where
  messageName _ = Data.Text.pack "utxorpc.v1.build.ChainParam"
  packedMessageDescriptor _
    = "\n\
      \\n\
      \ChainParam\DC2\DLE\n\
...
{- | Fields :
         ...
         * 'Proto.Utxorpc.V1.Build.Build_Fields.slot' @:: Lens' ChainPoint Data.Word.Word64@
         * 'Proto.Utxorpc.V1.Build.Build_Fields.height' @:: Lens' ChainPoint Data.Word.Word64@
         * 'Proto.Utxorpc.V1.Build.Build_Fields.hash' @:: Lens' ChainPoint Data.ByteString.ByteString@ -}
data ChainPoint
...
instance Data.ProtoLens.Message ChainPoint where
  messageName _ = Data.Text.pack "utxorpc.v1.build.ChainPoint"
  packedMessageDescriptor _
    = "\n\
      \\n\
      \ChainPoint\DC2\DC2\n\
...
{- | Fields :
         ...
         * 'Proto.Utxorpc.V1.Build.Build_Fields.param' @:: Lens' GetChainParamRequest [Data.Text.Text]@
         * 'Proto.Utxorpc.V1.Build.Build_Fields.vec'param' @:: Lens' GetChainParamRequest (Data.Vector.Vector Data.Text.Text)@ -}
...
instance Data.ProtoLens.Message GetChainParamRequest where
  messageName _
    = Data.Text.pack "utxorpc.v1.build.GetChainParamRequest"
  packedMessageDescriptor _
    = "\n\
...
{- | Fields :
         ...
         * 'Proto.Utxorpc.V1.Build.Build_Fields.param' @:: Lens' GetChainParamResponse [ChainParam]@
         * 'Proto.Utxorpc.V1.Build.Build_Fields.vec'param' @:: Lens' GetChainParamResponse (Data.Vector.Vector ChainParam)@ -}
...
instance Data.ProtoLens.Message GetChainParamResponse where
  messageName _
    = Data.Text.pack "utxorpc.v1.build.GetChainParamResponse"
  packedMessageDescriptor _
    = "\n\
      \\NAKGetChainParamResponse\DC22\n\
      \\ENQparam\CAN\SOH \ETX(\v2\FS.utxorpc.v1.build.ChainParamR\ENQparam"
  packedFileDescriptor _ = packedFileDescriptor
  fieldsByTag
    = let
        param__field_descriptor
...
instance Data.ProtoLens.Message GetChainTipRequest where
  messageName _
    = Data.Text.pack "utxorpc.v1.build.GetChainTipRequest"
  packedMessageDescriptor _
    = "\n\
...
{- | Fields :
         ...
         * 'Proto.Utxorpc.V1.Build.Build_Fields.tip' @:: Lens' GetChainTipResponse ChainPoint@
         * 'Proto.Utxorpc.V1.Build.Build_Fields.maybe'tip' @:: Lens' GetChainTipResponse (Prelude.Maybe ChainPoint)@ -}
...
instance Data.ProtoLens.Message GetChainTipResponse where
  messageName _
    = Data.Text.pack "utxorpc.v1.build.GetChainTipResponse"
  packedMessageDescriptor _
    = "\n\
      \\DC3GetChainTipResponse\DC2.\n\
      \\ETXtip\CAN\SOH \SOH(\v2\FS.utxorpc.v1.build.ChainPointR\ETXtip"
  packedFileDescriptor _ = packedFileDescriptor
  fieldsByTag
    = let
...
{- | Fields :
         ...
         * 'Proto.Utxorpc.V1.Build.Build_Fields.address' @:: Lens' GetUtxoByAddressRequest [Data.ByteString.ByteString]@
         * 'Proto.Utxorpc.V1.Build.Build_Fields.vec'address' @:: Lens' GetUtxoByAddressRequest (Data.Vector.Vector Data.ByteString.ByteString)@
         * 'Proto.Utxorpc.V1.Build.Build_Fields.acquirePoint' @:: Lens' GetUtxoByAddressRequest ChainPoint@
         * 'Proto.Utxorpc.V1.Build.Build_Fields.maybe'acquirePoint' @:: Lens' GetUtxoByAddressRequest (Prelude.Maybe ChainPoint)@ -}
...
instance Data.ProtoLens.Message GetUtxoByAddressRequest where
  messageName _
    = Data.Text.pack "utxorpc.v1.build.GetUtxoByAddressRequest"
  packedMessageDescriptor _
    = "\n\
      \\ETBGetUtxoByAddressRequest\DC2\CAN\n\
      \\aaddress\CAN\SOH \ETX(\fR\aaddress\DC2A\n\
      \\racquire_point\CAN\STX \SOH(\v2\FS.utxorpc.v1.build.ChainPointR\facquirePoint"
  packedFileDescriptor _ = packedFileDescriptor
  fieldsByTag
    = let
...
{- | Fields :
         ...
         * 'Proto.Utxorpc.V1.Build.Build_Fields.items' @:: Lens' GetUtxoByAddressResponse [AnyChainUtxo]@
         * 'Proto.Utxorpc.V1.Build.Build_Fields.vec'items' @:: Lens' GetUtxoByAddressResponse (Data.Vector.Vector AnyChainUtxo)@
         * 'Proto.Utxorpc.V1.Build.Build_Fields.nextToken' @:: Lens' GetUtxoByAddressResponse Data.Text.Text@ -}
...
instance Data.ProtoLens.Message GetUtxoByAddressResponse where
  messageName _
    = Data.Text.pack "utxorpc.v1.build.GetUtxoByAddressResponse"
  packedMessageDescriptor _
    = "\n\
      \\CANGetUtxoByAddressResponse\DC24\n\
      \\ENQitems\CAN\SOH \ETX(\v2\RS.utxorpc.v1.build.AnyChainUtxoR\ENQitems\DC2\GS\n\
      \\n\
...
{- | Fields :
         ...
         * 'Proto.Utxorpc.V1.Build.Build_Fields.ref' @:: Lens' GetUtxoByRefRequest [UtxoRef]@
         * 'Proto.Utxorpc.V1.Build.Build_Fields.vec'ref' @:: Lens' GetUtxoByRefRequest (Data.Vector.Vector UtxoRef)@
         * 'Proto.Utxorpc.V1.Build.Build_Fields.acquirePoint' @:: Lens' GetUtxoByRefRequest ChainPoint@
         * 'Proto.Utxorpc.V1.Build.Build_Fields.maybe'acquirePoint' @:: Lens' GetUtxoByRefRequest (Prelude.Maybe ChainPoint)@ -}
...
instance Data.ProtoLens.Message GetUtxoByRefRequest where
  messageName _
    = Data.Text.pack "utxorpc.v1.build.GetUtxoByRefRequest"
  packedMessageDescriptor _
    = "\n\
      \\DC3GetUtxoByRefRequest\DC2+\n\
      \\ETXref\CAN\SOH \ETX(\v2\EM.utxorpc.v1.build.UtxoRefR\ETXref\DC2A\n\
      \\racquire_point\CAN\STX \SOH(\v2\FS.utxorpc.v1.build.ChainPointR\facquirePoint"
  packedFileDescriptor _ = packedFileDescriptor
  fieldsByTag
    = let
...
{- | Fields :
         ...
         * 'Proto.Utxorpc.V1.Build.Build_Fields.items' @:: Lens' GetUtxoByRefResponse [AnyChainUtxo]@
         * 'Proto.Utxorpc.V1.Build.Build_Fields.vec'items' @:: Lens' GetUtxoByRefResponse (Data.Vector.Vector AnyChainUtxo)@
         * 'Proto.Utxorpc.V1.Build.Build_Fields.nextToken' @:: Lens' GetUtxoByRefResponse Data.Text.Text@ -}
...
instance Data.ProtoLens.Message GetUtxoByRefResponse where
  messageName _
    = Data.Text.pack "utxorpc.v1.build.GetUtxoByRefResponse"
  packedMessageDescriptor _
    = "\n\
...
{- | Fields :
         ...
         * 'Proto.Utxorpc.V1.Build.Build_Fields.refs' @:: Lens' HoldUtxoRequest [UtxoRef]@
         * 'Proto.Utxorpc.V1.Build.Build_Fields.vec'refs' @:: Lens' HoldUtxoRequest (Data.Vector.Vector UtxoRef)@ -}
...
instance Data.ProtoLens.Message HoldUtxoRequest where
  messageName _ = Data.Text.pack "utxorpc.v1.build.HoldUtxoRequest"
  packedMessageDescriptor _
    = "\n\
      \\SIHoldUtxoRequest\DC2-\n\
      \\EOTrefs\CAN\SOH \ETX(\v2\EM.utxorpc.v1.build.UtxoRefR\EOTrefs"
  packedFileDescriptor _ = packedFileDescriptor
  fieldsByTag
    = let
...
{- | Fields :
         ...
         * 'Proto.Utxorpc.V1.Build.Build_Fields.lost' @:: Lens' HoldUtxoResponse [UtxoRef]@
         * 'Proto.Utxorpc.V1.Build.Build_Fields.vec'lost' @:: Lens' HoldUtxoResponse (Data.Vector.Vector UtxoRef)@ -}
...
instance Data.ProtoLens.Message HoldUtxoResponse where
  messageName _ = Data.Text.pack "utxorpc.v1.build.HoldUtxoResponse"
  packedMessageDescriptor _
    = "\n\
      \\DLEHoldUtxoResponse\DC2-\n\
      \\EOTlost\CAN\SOH \ETX(\v2\EM.utxorpc.v1.build.UtxoRefR\EOTlost"
  packedFileDescriptor _ = packedFileDescriptor
  fieldsByTag
    = let
...
{- | Fields :
         ...
         * 'Proto.Utxorpc.V1.Build.Build_Fields.hash' @:: Lens' UtxoRef Data.ByteString.ByteString@
         * 'Proto.Utxorpc.V1.Build.Build_Fields.index' @:: Lens' UtxoRef Data.Word.Word32@ -}
data UtxoRef
...
instance Data.ProtoLens.Message UtxoRef where
  messageName _ = Data.Text.pack "utxorpc.v1.build.UtxoRef"
  packedMessageDescriptor _
    = "\n\
      \\aUtxoRef\DC2\DC2\n\
...
instance Data.ProtoLens.Service.Types.Service LedgerStateService where
  ...
  type ServicePackage LedgerStateService = "utxorpc.v1.build"
  ...
  packedServiceDescriptor _
    = "\n\
      ...
      \\vGetChainTip\DC2$.utxorpc.v1.build.GetChainTipRequest\SUB%.utxorpc.v1.build.GetChainTipResponse\DC2`\n\
      \\rGetChainParam\DC2&.utxorpc.v1.build.GetChainParamRequest\SUB'.utxorpc.v1.build.GetChainParamResponse\DC2i\n\
      \\DLEGetUtxoByAddress\DC2).utxorpc.v1.build.GetUtxoByAddressRequest\SUB*.utxorpc.v1.build.GetUtxoByAddressResponse\DC2]\n\
      \\fGetUtxoByRef\DC2%.utxorpc.v1.build.GetUtxoByRefRequest\SUB&.utxorpc.v1.build.GetUtxoByRefResponse\DC2S\n\
      \\bHoldUtxo\DC2!.utxorpc.v1.build.HoldUtxoRequest\SUB\".utxorpc.v1.build.HoldUtxoResponse0\SOH"
...
packedFileDescriptor
  = "\n\
    \\FSutxorpc/v1/build/build.proto\DC2\DLEutxorpc.v1.build\SUB google/protobuf/field_mask.proto\SUB utxorpc/v1/cardano/cardano.proto\"L\n\
    \\n\
    \ChainPoint\DC2\DC2\n\
    \\EOTslot\CAN\SOH \SOH(\EOTR\EOTslot\DC2\SYN\n\
    \\ACKheight\CAN\STX \SOH(\EOTR\ACKheight\DC2\DC2\n\
    ...
    \\NAKGetChainParamResponse\DC22\n\
    \\ENQparam\CAN\SOH \ETX(\v2\FS.utxorpc.v1.build.ChainParamR\ENQparam\"v\n\
    \\ETBGetUtxoByAddressRequest\DC2\CAN\n\
    \\aaddress\CAN\SOH \ETX(\fR\aaddress\DC2A\n\
    \\racquire_point\CAN\STX \SOH(\v2\FS.utxorpc.v1.build.ChainPointR\facquirePoint\"Q\n\
    \\fAnyChainUtxo\DC28\n\
    \\acardano\CAN\SOH \SOH(\v2\FS.utxorpc.v1.cardano.TxOutputH\NULR\acardanoB\a\n\
    \\ENQchain\"o\n\
    \\CANGetUtxoByAddressResponse\DC24\n\
    ...
    \\DC3GetUtxoByRefRequest\DC2+\n\
    \\ETXref\CAN\SOH \ETX(\v2\EM.utxorpc.v1.build.UtxoRefR\ETXref\DC2A\n\
    \\racquire_point\CAN\STX \SOH(\v2\FS.utxorpc.v1.build.ChainPointR\facquirePoint\"k\n\
    \\DC4GetUtxoByRefResponse\DC24\n\
    \\ENQitems\CAN\SOH \ETX(\v2\RS.utxorpc.v1.build.AnyChainUtxoR\ENQitems\DC2\GS\n\
    \\n\
    \next_token\CAN\STX \SOH(\tR\tnextToken\"@\n\
    \\SIHoldUtxoRequest\DC2-\n\
    \\EOTrefs\CAN\SOH \ETX(\v2\EM.utxorpc.v1.build.UtxoRefR\EOTrefs\"A\n\
    \\DLEHoldUtxoResponse\DC2-\n\
    \\EOTlost\CAN\SOH \ETX(\v2\EM.utxorpc.v1.build.UtxoRefR\EOTlost2\241\ETX\n\
    \\DC2LedgerStateService\DC2Z\n\
    \\vGetChainTip\DC2$.utxorpc.v1.build.GetChainTipRequest\SUB%.utxorpc.v1.build.GetChainTipResponse\DC2`\n\
    \\rGetChainParam\DC2&.utxorpc.v1.build.GetChainParamRequest\SUB'.utxorpc.v1.build.GetChainParamResponse\DC2i\n\
    \\DLEGetUtxoByAddress\DC2).utxorpc.v1.build.GetUtxoByAddressRequest\SUB*.utxorpc.v1.build.GetUtxoByAddressResponse\DC2]\n\
    \\fGetUtxoByRef\DC2%.utxorpc.v1.build.GetUtxoByRefRequest\SUB&.utxorpc.v1.build.GetUtxoByRefResponse\DC2S\n\
    \\bHoldUtxo\DC2!.utxorpc.v1.build.HoldUtxoRequest\SUB\".utxorpc.v1.build.HoldUtxoResponse0\SOHB\181\SOH\n\
    \\DC4com.utxorpc.v1.buildB\n\
    \BuildProtoP\SOHZ/github.com/utxorpc/spec/gen/go/utxorpc/v1/build\162\STX\ETXUVB\170\STX\DLEUtxorpc.V1.Build\202\STX\DLEUtxorpc\\V1\\Build\226\STX\FSUtxorpc\\V1\\Build\\GPBMetadata\234\STX\DC2Utxorpc::V1::BuildJ\202\ESC\n\
