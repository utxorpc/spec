...
import (
	...
	context "context"
	errors "errors"
	sync "github.com/utxorpc/spec/gen/go/utxorpc/v1/sync"
	http "net/http"
	strings "strings"
)
...
const (
	...
	ChainSyncServiceName = "utxorpc.v1.sync.ChainSyncService"
)
...
const (
	...
	// FetchBlock RPC.
	ChainSyncServiceFetchBlockProcedure = "/utxorpc.v1.sync.ChainSyncService/FetchBlock"
	// ChainSyncServiceDumpHistoryProcedure is the fully-qualified name of the ChainSyncService's
	// DumpHistory RPC.
	ChainSyncServiceDumpHistoryProcedure = "/utxorpc.v1.sync.ChainSyncService/DumpHistory"
	// ChainSyncServiceFollowTipProcedure is the fully-qualified name of the ChainSyncService's
	// FollowTip RPC.
	ChainSyncServiceFollowTipProcedure = "/utxorpc.v1.sync.ChainSyncService/FollowTip"
)

// These variables are the protoreflect.Descriptor objects for the RPCs defined in this package.
var (
	chainSyncServiceServiceDescriptor           = sync.File_utxorpc_v1_sync_sync_proto.Services().ByName("ChainSyncService")
...
// ChainSyncServiceClient is a client for the utxorpc.v1.sync.ChainSyncService service.
...
// NewChainSyncServiceClient constructs a client for the utxorpc.v1.sync.ChainSyncService service.
...
// FetchBlock calls utxorpc.v1.sync.ChainSyncService.FetchBlock.
...
// DumpHistory calls utxorpc.v1.sync.ChainSyncService.DumpHistory.
...
// FollowTip calls utxorpc.v1.sync.ChainSyncService.FollowTip.
...
// ChainSyncServiceHandler is an implementation of the utxorpc.v1.sync.ChainSyncService service.
...
func NewChainSyncServiceHandler(svc ChainSyncServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/utxorpc.v1.sync.ChainSyncService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedChainSyncServiceHandler) FetchBlock(context.Context, *connect.Request[sync.FetchBlockRequest]) (*connect.Response[sync.FetchBlockResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("utxorpc.v1.sync.ChainSyncService.FetchBlock is not implemented"))
}
...
func (UnimplementedChainSyncServiceHandler) DumpHistory(context.Context, *connect.Request[sync.DumpHistoryRequest]) (*connect.Response[sync.DumpHistoryResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("utxorpc.v1.sync.ChainSyncService.DumpHistory is not implemented"))
}
...
func (UnimplementedChainSyncServiceHandler) FollowTip(context.Context, *connect.Request[sync.FollowTipRequest], *connect.ServerStream[sync.FollowTipResponse]) error {
	return connect.NewError(connect.CodeUnimplemented, errors.New("utxorpc.v1.sync.ChainSyncService.FollowTip is not implemented"))
}
