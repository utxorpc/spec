...
import (
	...
	context "context"
	errors "errors"
	build "github.com/utxorpc/spec/gen/go/utxorpc/v1/build"
	http "net/http"
	strings "strings"
)
...
var (
	ledgerStateServiceServiceDescriptor                = build.File_utxorpc_v1_build_build_proto.Services().ByName("LedgerStateService")
