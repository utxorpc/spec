...
import (
	...
	context "context"
	errors "errors"
	watch "github.com/utxorpc/spec/gen/go/utxorpc/v1/watch"
	http "net/http"
	strings "strings"
)
...
const (
	...
	WatchServiceName = "utxorpc.v1.watch.WatchService"
)
...
const (
	...
	WatchServiceWatchTxProcedure = "/utxorpc.v1.watch.WatchService/WatchTx"
)

// These variables are the protoreflect.Descriptor objects for the RPCs defined in this package.
var (
	watchServiceServiceDescriptor       = watch.File_utxorpc_v1_watch_watch_proto.Services().ByName("WatchService")
	watchServiceWatchTxMethodDescriptor = watchServiceServiceDescriptor.Methods().ByName("WatchTx")
)

// WatchServiceClient is a client for the utxorpc.v1.watch.WatchService service.
...
// NewWatchServiceClient constructs a client for the utxorpc.v1.watch.WatchService service. By
...
// WatchTx calls utxorpc.v1.watch.WatchService.WatchTx.
...
// WatchServiceHandler is an implementation of the utxorpc.v1.watch.WatchService service.
...
func NewWatchServiceHandler(svc WatchServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/utxorpc.v1.watch.WatchService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedWatchServiceHandler) WatchTx(context.Context, *connect.Request[watch.WatchTxRequest], *connect.ServerStream[watch.WatchTxResponse]) error {
	return connect.NewError(connect.CodeUnimplemented, errors.New("utxorpc.v1.watch.WatchService.WatchTx is not implemented"))
}
