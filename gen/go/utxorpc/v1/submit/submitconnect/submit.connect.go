...
import (
	...
	context "context"
	errors "errors"
	submit "github.com/utxorpc/spec/gen/go/utxorpc/v1/submit"
	http "net/http"
	strings "strings"
)
...
const (
	...
	SubmitServiceName = "utxorpc.v1.submit.SubmitService"
)
...
const (
	...
	SubmitServiceSubmitTxProcedure = "/utxorpc.v1.submit.SubmitService/SubmitTx"
	// SubmitServiceWaitForTxProcedure is the fully-qualified name of the SubmitService's WaitForTx RPC.
	SubmitServiceWaitForTxProcedure = "/utxorpc.v1.submit.SubmitService/WaitForTx"
	// SubmitServiceReadMempoolProcedure is the fully-qualified name of the SubmitService's ReadMempool
	// RPC.
	SubmitServiceReadMempoolProcedure = "/utxorpc.v1.submit.SubmitService/ReadMempool"
	// SubmitServiceWatchMempoolProcedure is the fully-qualified name of the SubmitService's
	// WatchMempool RPC.
	SubmitServiceWatchMempoolProcedure = "/utxorpc.v1.submit.SubmitService/WatchMempool"
)

// These variables are the protoreflect.Descriptor objects for the RPCs defined in this package.
var (
	submitServiceServiceDescriptor            = submit.File_utxorpc_v1_submit_submit_proto.Services().ByName("SubmitService")
...
// SubmitServiceClient is a client for the utxorpc.v1.submit.SubmitService service.
...
// NewSubmitServiceClient constructs a client for the utxorpc.v1.submit.SubmitService service. By
...
// SubmitTx calls utxorpc.v1.submit.SubmitService.SubmitTx.
...
// WaitForTx calls utxorpc.v1.submit.SubmitService.WaitForTx.
...
// ReadMempool calls utxorpc.v1.submit.SubmitService.ReadMempool.
...
// WatchMempool calls utxorpc.v1.submit.SubmitService.WatchMempool.
...
// SubmitServiceHandler is an implementation of the utxorpc.v1.submit.SubmitService service.
...
func NewSubmitServiceHandler(svc SubmitServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/utxorpc.v1.submit.SubmitService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedSubmitServiceHandler) SubmitTx(context.Context, *connect.Request[submit.SubmitTxRequest]) (*connect.Response[submit.SubmitTxResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("utxorpc.v1.submit.SubmitService.SubmitTx is not implemented"))
}
...
func (UnimplementedSubmitServiceHandler) WaitForTx(context.Context, *connect.Request[submit.WaitForTxRequest], *connect.ServerStream[submit.WaitForTxResponse]) error {
	return connect.NewError(connect.CodeUnimplemented, errors.New("utxorpc.v1.submit.SubmitService.WaitForTx is not implemented"))
}
...
func (UnimplementedSubmitServiceHandler) ReadMempool(context.Context, *connect.Request[submit.ReadMempoolRequest]) (*connect.Response[submit.ReadMempoolResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("utxorpc.v1.submit.SubmitService.ReadMempool is not implemented"))
}
...
func (UnimplementedSubmitServiceHandler) WatchMempool(context.Context, *connect.Request[submit.WatchMempoolRequest], *connect.ServerStream[submit.WatchMempoolResponse]) error {
	return connect.NewError(connect.CodeUnimplemented, errors.New("utxorpc.v1.submit.SubmitService.WatchMempool is not implemented"))
}
