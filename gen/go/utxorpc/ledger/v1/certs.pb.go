...
type PoolRegistrationCert struct {
	...
	Pledge        *Coin         `protobuf:"bytes,3,opt,name=pledge,proto3" json:"pledge,omitempty"`                                    // Pledge amount.
	Cost          *Coin         `protobuf:"bytes,4,opt,name=cost,proto3" json:"cost,omitempty"`                                        // Pool cost.
...
func (x *PoolRegistrationCert) GetPledge() *Coin {
	if x != nil {
		return x.Pledge
	}
	return nil
...
func (x *PoolRegistrationCert) GetCost() *Coin {
	if x != nil {
		return x.Cost
	}
	return nil
...
var file_utxorpc_ledger_v1_certs_proto_rawDesc = []byte{
	...
	0x3a, 0x3a, 0x4c, 0x65, 0x64, 0x67, 0x65, 0x72, 0x3a, 0x3a, 0x56, 0x31, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
...
var file_utxorpc_ledger_v1_certs_proto_goTypes = []interface{}{
	...
	(*Coin)(nil),                        // 10: utxorpc.ledger.v1.Coin
}
var file_utxorpc_ledger_v1_certs_proto_depIdxs = []int32{
	...
	10, // 8: utxorpc.ledger.v1.PoolRegistrationCert.pledge:type_name -> utxorpc.ledger.v1.Coin
	10, // 9: utxorpc.ledger.v1.PoolRegistrationCert.cost:type_name -> utxorpc.ledger.v1.Coin
	1,  // 10: utxorpc.ledger.v1.PoolRegistrationCert.margin:type_name -> utxorpc.ledger.v1.UnitInterval
	2,  // 11: utxorpc.ledger.v1.PoolRegistrationCert.relays:type_name -> utxorpc.ledger.v1.Relay
	3,  // 12: utxorpc.ledger.v1.PoolRegistrationCert.pool_metadata:type_name -> utxorpc.ledger.v1.PoolMetadata
