...
type TxOutput struct {
	...
	Coin      *Coin         `protobuf:"bytes,2,opt,name=coin,proto3" json:"coin,omitempty"`                            // Amount of ADA in the output.
...
type Collateral struct {
	...
	TotalCollateral  *Coin      `protobuf:"bytes,3,opt,name=total_collateral,json=totalCollateral,proto3" json:"total_collateral,omitempty"`    // Total amount of collateral.
}
...
func (x *Collateral) GetTotalCollateral() *Coin {
	if x != nil {
...
type Withdrawal struct {
	...
	Coin          *Coin  `protobuf:"bytes,2,opt,name=coin,proto3" json:"coin,omitempty"`                                        // Amount of ADA withdrawn.
}
...
func (x *Withdrawal) GetCoin() *Coin {
	if x != nil {
		return x.Coin
	}
	return nil
...
var file_utxorpc_ledger_v1_tx_proto_goTypes = []interface{}{
	...
	(*Coin)(nil),        // 14: utxorpc.ledger.v1.Coin
	(*Script)(nil),      // 15: utxorpc.ledger.v1.Script
	(*Metadata)(nil),    // 16: utxorpc.ledger.v1.Metadata
	(*Certificate)(nil), // 17: utxorpc.ledger.v1.Certificate
}
var file_utxorpc_ledger_v1_tx_proto_depIdxs = []int32{
	...
	14, // 3: utxorpc.ledger.v1.TxOutput.coin:type_name -> utxorpc.ledger.v1.Coin
	5,  // 4: utxorpc.ledger.v1.TxOutput.assets:type_name -> utxorpc.ledger.v1.Multiasset
	13, // 5: utxorpc.ledger.v1.TxOutput.datum:type_name -> utxorpc.ledger.v1.PlutusData
	15, // 6: utxorpc.ledger.v1.TxOutput.script:type_name -> utxorpc.ledger.v1.Script
	1,  // 7: utxorpc.ledger.v1.TxOutput.redeemer:type_name -> utxorpc.ledger.v1.Redeemer
	4,  // 8: utxorpc.ledger.v1.Multiasset.assets:type_name -> utxorpc.ledger.v1.Asset
	2,  // 9: utxorpc.ledger.v1.Collateral.collateral:type_name -> utxorpc.ledger.v1.TxInput
	3,  // 10: utxorpc.ledger.v1.Collateral.collateral_return:type_name -> utxorpc.ledger.v1.TxOutput
	14, // 11: utxorpc.ledger.v1.Collateral.total_collateral:type_name -> utxorpc.ledger.v1.Coin
	14, // 12: utxorpc.ledger.v1.Withdrawal.coin:type_name -> utxorpc.ledger.v1.Coin
	12, // 13: utxorpc.ledger.v1.WitnessSet.vkeywitness:type_name -> utxorpc.ledger.v1.VKeyWitness
	15, // 14: utxorpc.ledger.v1.WitnessSet.script:type_name -> utxorpc.ledger.v1.Script
	13, // 15: utxorpc.ledger.v1.WitnessSet.plutus_datums:type_name -> utxorpc.ledger.v1.PlutusData
	16, // 16: utxorpc.ledger.v1.AuxData.metadata:type_name -> utxorpc.ledger.v1.Metadata
	15, // 17: utxorpc.ledger.v1.AuxData.scripts:type_name -> utxorpc.ledger.v1.Script
	2,  // 18: utxorpc.ledger.v1.Tx.inputs:type_name -> utxorpc.ledger.v1.TxInput
	3,  // 19: utxorpc.ledger.v1.Tx.outputs:type_name -> utxorpc.ledger.v1.TxOutput
	17, // 20: utxorpc.ledger.v1.Tx.certificates:type_name -> utxorpc.ledger.v1.Certificate
	8,  // 21: utxorpc.ledger.v1.Tx.withdrawals:type_name -> utxorpc.ledger.v1.Withdrawal
	5,  // 22: utxorpc.ledger.v1.Tx.mint:type_name -> utxorpc.ledger.v1.Multiasset
	2,  // 23: utxorpc.ledger.v1.Tx.reference_inputs:type_name -> utxorpc.ledger.v1.TxInput
	9,  // 24: utxorpc.ledger.v1.Tx.witnesses:type_name -> utxorpc.ledger.v1.WitnessSet
	7,  // 25: utxorpc.ledger.v1.Tx.collateral:type_name -> utxorpc.ledger.v1.Collateral
	6,  // 26: utxorpc.ledger.v1.Tx.validity:type_name -> utxorpc.ledger.v1.TxValidity
	10, // 27: utxorpc.ledger.v1.Tx.auxiliary:type_name -> utxorpc.ledger.v1.AuxData
...
func file_utxorpc_ledger_v1_tx_proto_init() {
	...
	file_utxorpc_ledger_v1_primitives_proto_init()
