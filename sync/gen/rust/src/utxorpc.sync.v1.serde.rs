...
impl serde::Serialize for AnyChainTx {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("utxorpc.sync.v1.AnyChainTx", len)?;
...
impl<'de> serde::Deserialize<'de> for AnyChainTx {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct utxorpc.sync.v1.AnyChainTx")
            }
...
;
        ...
        deserializer.deserialize_struct("utxorpc.sync.v1.AnyChainTx", FIELDS, GeneratedVisitor)
    }
}
