{- This file was auto-generated from utxorpc/build/v1/build.proto by the proto-lens-protoc program. -}
{-# LANGUAGE ScopedTypeVariables, DataKinds, TypeFamilies, UndecidableInstances, GeneralizedNewtypeDeriving, MultiParamTypeClasses, FlexibleContexts, FlexibleInstances, PatternSynonyms, MagicHash, NoImplicitPrelude, DataKinds, BangPatterns, TypeApplications, OverloadedStrings, DerivingStrategies#-}
{-# OPTIONS_GHC -Wno-unused-imports#-}
{-# OPTIONS_GHC -Wno-duplicate-exports#-}
{-# OPTIONS_GHC -Wno-dodgy-exports#-}
module Proto.Utxorpc.Build.V1.Build (
...
{- | Fields :
         ...
         * 'Proto.Utxorpc.Build.V1.Build_Fields.maybe'chain' @:: Lens' AnyChainUtxo (Prelude.Maybe AnyChainUtxo'Chain)@
         * 'Proto.Utxorpc.Build.V1.Build_Fields.maybe'cardano' @:: Lens' AnyChainUtxo (Prelude.Maybe Proto.Utxorpc.Cardano.V1.Cardano.TxOutput)@
         * 'Proto.Utxorpc.Build.V1.Build_Fields.cardano' @:: Lens' AnyChainUtxo Proto.Utxorpc.Cardano.V1.Cardano.TxOutput@ -}
data AnyChainUtxo
...
data AnyChainUtxo'Chain
  = AnyChainUtxo'Cardano !Proto.Utxorpc.Cardano.V1.Cardano.TxOutput
...
instance Data.ProtoLens.Field.HasField AnyChainUtxo "maybe'chain" (Prelude.Maybe AnyChainUtxo'Chain) where
  fieldOf _
    = (Prelude..)
        ...
        Prelude.id
instance Data.ProtoLens.Field.HasField AnyChainUtxo "maybe'cardano" (Prelude.Maybe Proto.Utxorpc.Cardano.V1.Cardano.TxOutput) where
  fieldOf _
    = (Prelude..)
        (Lens.Family2.Unchecked.lens
           _AnyChainUtxo'chain (\ x__ y__ -> x__ {_AnyChainUtxo'chain = y__}))
...
instance Data.ProtoLens.Field.HasField AnyChainUtxo "cardano" Proto.Utxorpc.Cardano.V1.Cardano.TxOutput where
  fieldOf _
    = (Prelude..)
        (Lens.Family2.Unchecked.lens
           _AnyChainUtxo'chain (\ x__ y__ -> x__ {_AnyChainUtxo'chain = y__}))
...
instance Data.ProtoLens.Message AnyChainUtxo where
  messageName _ = Data.Text.pack "utxorpc.build.v1.AnyChainUtxo"
  packedMessageDescriptor _
    = "\n\
      \\fAnyChainUtxo\DC28\n\
      \\acardano\CAN\SOH \SOH(\v2\FS.utxorpc.cardano.v1.TxOutputH\NULR\acardanoB\a\n\
      \\ENQchain"
        ...
        cardano__field_descriptor
          = Data.ProtoLens.FieldDescriptor
              ...
              (Data.ProtoLens.MessageField Data.ProtoLens.MessageType ::
                 Data.ProtoLens.FieldTypeDescriptor Proto.Utxorpc.Cardano.V1.Cardano.TxOutput)
...
_AnyChainUtxo'Cardano ::
  Data.ProtoLens.Prism.Prism' AnyChainUtxo'Chain Proto.Utxorpc.Cardano.V1.Cardano.TxOutput
_AnyChainUtxo'Cardano
...
{- | Fields :
         ...
         * 'Proto.Utxorpc.Build.V1.Build_Fields.key' @:: Lens' ChainParam Data.Text.Text@
         * 'Proto.Utxorpc.Build.V1.Build_Fields.value' @:: Lens' ChainParam Data.ByteString.ByteString@ -}
data ChainParam
...
instance Data.ProtoLens.Message ChainParam where
  messageName _ = Data.Text.pack "utxorpc.build.v1.ChainParam"
  packedMessageDescriptor _
    = "\n\
      \\n\
      \ChainParam\DC2\DLE\n\
...
{- | Fields :
         ...
         * 'Proto.Utxorpc.Build.V1.Build_Fields.slot' @:: Lens' ChainPoint Data.Word.Word64@
         * 'Proto.Utxorpc.Build.V1.Build_Fields.height' @:: Lens' ChainPoint Data.Word.Word64@
         * 'Proto.Utxorpc.Build.V1.Build_Fields.hash' @:: Lens' ChainPoint Data.ByteString.ByteString@ -}
data ChainPoint
...
instance Data.ProtoLens.Message ChainPoint where
  messageName _ = Data.Text.pack "utxorpc.build.v1.ChainPoint"
  packedMessageDescriptor _
    = "\n\
      \\n\
      \ChainPoint\DC2\DC2\n\
...
{- | Fields :
         ...
         * 'Proto.Utxorpc.Build.V1.Build_Fields.param' @:: Lens' GetChainParamRequest [Data.Text.Text]@
         * 'Proto.Utxorpc.Build.V1.Build_Fields.vec'param' @:: Lens' GetChainParamRequest (Data.Vector.Vector Data.Text.Text)@ -}
...
instance Data.ProtoLens.Message GetChainParamRequest where
  messageName _
    = Data.Text.pack "utxorpc.build.v1.GetChainParamRequest"
  packedMessageDescriptor _
    = "\n\
...
{- | Fields :
         ...
         * 'Proto.Utxorpc.Build.V1.Build_Fields.param' @:: Lens' GetChainParamResponse [ChainParam]@
         * 'Proto.Utxorpc.Build.V1.Build_Fields.vec'param' @:: Lens' GetChainParamResponse (Data.Vector.Vector ChainParam)@ -}
...
instance Data.ProtoLens.Message GetChainParamResponse where
  messageName _
    = Data.Text.pack "utxorpc.build.v1.GetChainParamResponse"
  packedMessageDescriptor _
    = "\n\
      \\NAKGetChainParamResponse\DC22\n\
      \\ENQparam\CAN\SOH \ETX(\v2\FS.utxorpc.build.v1.ChainParamR\ENQparam"
  packedFileDescriptor _ = packedFileDescriptor
  fieldsByTag
    = let
        param__field_descriptor
...
instance Data.ProtoLens.Message GetChainTipRequest where
  messageName _
    = Data.Text.pack "utxorpc.build.v1.GetChainTipRequest"
  packedMessageDescriptor _
    = "\n\
...
{- | Fields :
         ...
         * 'Proto.Utxorpc.Build.V1.Build_Fields.tip' @:: Lens' GetChainTipResponse ChainPoint@
         * 'Proto.Utxorpc.Build.V1.Build_Fields.maybe'tip' @:: Lens' GetChainTipResponse (Prelude.Maybe ChainPoint)@ -}
...
instance Data.ProtoLens.Message GetChainTipResponse where
  messageName _
    = Data.Text.pack "utxorpc.build.v1.GetChainTipResponse"
  packedMessageDescriptor _
    = "\n\
      \\DC3GetChainTipResponse\DC2.\n\
      \\ETXtip\CAN\SOH \SOH(\v2\FS.utxorpc.build.v1.ChainPointR\ETXtip"
  packedFileDescriptor _ = packedFileDescriptor
  fieldsByTag
    = let
...
{- | Fields :
         ...
         * 'Proto.Utxorpc.Build.V1.Build_Fields.address' @:: Lens' GetUtxoByAddressRequest [Data.ByteString.ByteString]@
         * 'Proto.Utxorpc.Build.V1.Build_Fields.vec'address' @:: Lens' GetUtxoByAddressRequest (Data.Vector.Vector Data.ByteString.ByteString)@
         * 'Proto.Utxorpc.Build.V1.Build_Fields.acquirePoint' @:: Lens' GetUtxoByAddressRequest ChainPoint@
         * 'Proto.Utxorpc.Build.V1.Build_Fields.maybe'acquirePoint' @:: Lens' GetUtxoByAddressRequest (Prelude.Maybe ChainPoint)@ -}
...
instance Data.ProtoLens.Message GetUtxoByAddressRequest where
  messageName _
    = Data.Text.pack "utxorpc.build.v1.GetUtxoByAddressRequest"
  packedMessageDescriptor _
    = "\n\
      \\ETBGetUtxoByAddressRequest\DC2\CAN\n\
      \\aaddress\CAN\SOH \ETX(\fR\aaddress\DC2A\n\
      \\racquire_point\CAN\STX \SOH(\v2\FS.utxorpc.build.v1.ChainPointR\facquirePoint"
  packedFileDescriptor _ = packedFileDescriptor
  fieldsByTag
    = let
...
{- | Fields :
         ...
         * 'Proto.Utxorpc.Build.V1.Build_Fields.items' @:: Lens' GetUtxoByAddressResponse [AnyChainUtxo]@
         * 'Proto.Utxorpc.Build.V1.Build_Fields.vec'items' @:: Lens' GetUtxoByAddressResponse (Data.Vector.Vector AnyChainUtxo)@
         * 'Proto.Utxorpc.Build.V1.Build_Fields.nextToken' @:: Lens' GetUtxoByAddressResponse Data.Text.Text@ -}
...
instance Data.ProtoLens.Message GetUtxoByAddressResponse where
  messageName _
    = Data.Text.pack "utxorpc.build.v1.GetUtxoByAddressResponse"
  packedMessageDescriptor _
    = "\n\
      \\CANGetUtxoByAddressResponse\DC24\n\
      \\ENQitems\CAN\SOH \ETX(\v2\RS.utxorpc.build.v1.AnyChainUtxoR\ENQitems\DC2\GS\n\
      \\n\
...
{- | Fields :
         ...
         * 'Proto.Utxorpc.Build.V1.Build_Fields.ref' @:: Lens' GetUtxoByRefRequest [UtxoRef]@
         * 'Proto.Utxorpc.Build.V1.Build_Fields.vec'ref' @:: Lens' GetUtxoByRefRequest (Data.Vector.Vector UtxoRef)@
         * 'Proto.Utxorpc.Build.V1.Build_Fields.acquirePoint' @:: Lens' GetUtxoByRefRequest ChainPoint@
         * 'Proto.Utxorpc.Build.V1.Build_Fields.maybe'acquirePoint' @:: Lens' GetUtxoByRefRequest (Prelude.Maybe ChainPoint)@ -}
...
instance Data.ProtoLens.Message GetUtxoByRefRequest where
  messageName _
    = Data.Text.pack "utxorpc.build.v1.GetUtxoByRefRequest"
  packedMessageDescriptor _
    = "\n\
      \\DC3GetUtxoByRefRequest\DC2+\n\
      \\ETXref\CAN\SOH \ETX(\v2\EM.utxorpc.build.v1.UtxoRefR\ETXref\DC2A\n\
      \\racquire_point\CAN\STX \SOH(\v2\FS.utxorpc.build.v1.ChainPointR\facquirePoint"
  packedFileDescriptor _ = packedFileDescriptor
  fieldsByTag
    = let
...
{- | Fields :
         ...
         * 'Proto.Utxorpc.Build.V1.Build_Fields.items' @:: Lens' GetUtxoByRefResponse [AnyChainUtxo]@
         * 'Proto.Utxorpc.Build.V1.Build_Fields.vec'items' @:: Lens' GetUtxoByRefResponse (Data.Vector.Vector AnyChainUtxo)@
         * 'Proto.Utxorpc.Build.V1.Build_Fields.nextToken' @:: Lens' GetUtxoByRefResponse Data.Text.Text@ -}
...
instance Data.ProtoLens.Message GetUtxoByRefResponse where
  messageName _
    = Data.Text.pack "utxorpc.build.v1.GetUtxoByRefResponse"
  packedMessageDescriptor _
    = "\n\
...
{- | Fields :
         ...
         * 'Proto.Utxorpc.Build.V1.Build_Fields.refs' @:: Lens' HoldUtxoRequest [UtxoRef]@
         * 'Proto.Utxorpc.Build.V1.Build_Fields.vec'refs' @:: Lens' HoldUtxoRequest (Data.Vector.Vector UtxoRef)@ -}
...
instance Data.ProtoLens.Message HoldUtxoRequest where
  messageName _ = Data.Text.pack "utxorpc.build.v1.HoldUtxoRequest"
  packedMessageDescriptor _
    = "\n\
      \\SIHoldUtxoRequest\DC2-\n\
      \\EOTrefs\CAN\SOH \ETX(\v2\EM.utxorpc.build.v1.UtxoRefR\EOTrefs"
  packedFileDescriptor _ = packedFileDescriptor
  fieldsByTag
    = let
...
{- | Fields :
         ...
         * 'Proto.Utxorpc.Build.V1.Build_Fields.lost' @:: Lens' HoldUtxoResponse [UtxoRef]@
         * 'Proto.Utxorpc.Build.V1.Build_Fields.vec'lost' @:: Lens' HoldUtxoResponse (Data.Vector.Vector UtxoRef)@ -}
...
instance Data.ProtoLens.Message HoldUtxoResponse where
  messageName _ = Data.Text.pack "utxorpc.build.v1.HoldUtxoResponse"
  packedMessageDescriptor _
    = "\n\
      \\DLEHoldUtxoResponse\DC2-\n\
      \\EOTlost\CAN\SOH \ETX(\v2\EM.utxorpc.build.v1.UtxoRefR\EOTlost"
  packedFileDescriptor _ = packedFileDescriptor
  fieldsByTag
    = let
...
{- | Fields :
         ...
         * 'Proto.Utxorpc.Build.V1.Build_Fields.hash' @:: Lens' UtxoRef Data.ByteString.ByteString@
         * 'Proto.Utxorpc.Build.V1.Build_Fields.index' @:: Lens' UtxoRef Data.Word.Word32@ -}
data UtxoRef
...
instance Data.ProtoLens.Message UtxoRef where
  messageName _ = Data.Text.pack "utxorpc.build.v1.UtxoRef"
  packedMessageDescriptor _
    = "\n\
      \\aUtxoRef\DC2\DC2\n\
...
instance Data.ProtoLens.Service.Types.Service LedgerStateService where
  ...
  type ServicePackage LedgerStateService = "utxorpc.build.v1"
  ...
  packedServiceDescriptor _
    = "\n\
      ...
      \\vGetChainTip\DC2$.utxorpc.build.v1.GetChainTipRequest\SUB%.utxorpc.build.v1.GetChainTipResponse\DC2`\n\
      \\rGetChainParam\DC2&.utxorpc.build.v1.GetChainParamRequest\SUB'.utxorpc.build.v1.GetChainParamResponse\DC2i\n\
      \\DLEGetUtxoByAddress\DC2).utxorpc.build.v1.GetUtxoByAddressRequest\SUB*.utxorpc.build.v1.GetUtxoByAddressResponse\DC2]\n\
      \\fGetUtxoByRef\DC2%.utxorpc.build.v1.GetUtxoByRefRequest\SUB&.utxorpc.build.v1.GetUtxoByRefResponse\DC2S\n\
      \\bHoldUtxo\DC2!.utxorpc.build.v1.HoldUtxoRequest\SUB\".utxorpc.build.v1.HoldUtxoResponse0\SOH"
...
packedFileDescriptor
  = "\n\
    \\FSutxorpc/build/v1/build.proto\DC2\DLEutxorpc.build.v1\SUB google/protobuf/field_mask.proto\SUB utxorpc/cardano/v1/cardano.proto\"L\n\
    \\n\
    \ChainPoint\DC2\DC2\n\
    \\EOTslot\CAN\SOH \SOH(\EOTR\EOTslot\DC2\SYN\n\
    \\ACKheight\CAN\STX \SOH(\EOTR\ACKheight\DC2\DC2\n\
    ...
    \\NAKGetChainParamResponse\DC22\n\
    \\ENQparam\CAN\SOH \ETX(\v2\FS.utxorpc.build.v1.ChainParamR\ENQparam\"v\n\
    \\ETBGetUtxoByAddressRequest\DC2\CAN\n\
    \\aaddress\CAN\SOH \ETX(\fR\aaddress\DC2A\n\
    \\racquire_point\CAN\STX \SOH(\v2\FS.utxorpc.build.v1.ChainPointR\facquirePoint\"Q\n\
    \\fAnyChainUtxo\DC28\n\
    \\acardano\CAN\SOH \SOH(\v2\FS.utxorpc.cardano.v1.TxOutputH\NULR\acardanoB\a\n\
    \\ENQchain\"o\n\
    \\CANGetUtxoByAddressResponse\DC24\n\
    ...
    \\DC3GetUtxoByRefRequest\DC2+\n\
    \\ETXref\CAN\SOH \ETX(\v2\EM.utxorpc.build.v1.UtxoRefR\ETXref\DC2A\n\
    \\racquire_point\CAN\STX \SOH(\v2\FS.utxorpc.build.v1.ChainPointR\facquirePoint\"k\n\
    \\DC4GetUtxoByRefResponse\DC24\n\
    \\ENQitems\CAN\SOH \ETX(\v2\RS.utxorpc.build.v1.AnyChainUtxoR\ENQitems\DC2\GS\n\
    \\n\
    \next_token\CAN\STX \SOH(\tR\tnextToken\"@\n\
    \\SIHoldUtxoRequest\DC2-\n\
    \\EOTrefs\CAN\SOH \ETX(\v2\EM.utxorpc.build.v1.UtxoRefR\EOTrefs\"A\n\
    \\DLEHoldUtxoResponse\DC2-\n\
    \\EOTlost\CAN\SOH \ETX(\v2\EM.utxorpc.build.v1.UtxoRefR\EOTlost2\241\ETX\n\
    \\DC2LedgerStateService\DC2Z\n\
    \\vGetChainTip\DC2$.utxorpc.build.v1.GetChainTipRequest\SUB%.utxorpc.build.v1.GetChainTipResponse\DC2`\n\
    \\rGetChainParam\DC2&.utxorpc.build.v1.GetChainParamRequest\SUB'.utxorpc.build.v1.GetChainParamResponse\DC2i\n\
    \\DLEGetUtxoByAddress\DC2).utxorpc.build.v1.GetUtxoByAddressRequest\SUB*.utxorpc.build.v1.GetUtxoByAddressResponse\DC2]\n\
    \\fGetUtxoByRef\DC2%.utxorpc.build.v1.GetUtxoByRefRequest\SUB&.utxorpc.build.v1.GetUtxoByRefResponse\DC2S\n\
    \\bHoldUtxo\DC2!.utxorpc.build.v1.HoldUtxoRequest\SUB\".utxorpc.build.v1.HoldUtxoResponse0\SOHB\191\SOH\n\
    \\DC4com.utxorpc.build.v1B\n\
    \BuildProtoP\SOHZ9github.com/bufbuild/buf-tour/gen/utxorpc/build/v1;buildv1\162\STX\ETXUBX\170\STX\DLEUtxorpc.Build.V1\202\STX\DLEUtxorpc\\Build\\V1\226\STX\FSUtxorpc\\Build\\V1\\GPBMetadata\234\STX\DC2Utxorpc::Build::V1J\202\ESC\n\
