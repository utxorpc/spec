...
impl serde::Serialize for AnyChainUtxo {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("utxorpc.build.v1.AnyChainUtxo", len)?;
...
impl<'de> serde::Deserialize<'de> for AnyChainUtxo {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct utxorpc.build.v1.AnyChainUtxo")
            }
...
;
        ...
        deserializer.deserialize_struct("utxorpc.build.v1.AnyChainUtxo", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ChainParam {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("utxorpc.build.v1.ChainParam", len)?;
        if !self.key.is_empty() {
...
impl<'de> serde::Deserialize<'de> for ChainParam {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct utxorpc.build.v1.ChainParam")
            }
        ...
        deserializer.deserialize_struct("utxorpc.build.v1.ChainParam", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ChainPoint {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("utxorpc.build.v1.ChainPoint", len)?;
        if self.slot != 0 {
...
impl<'de> serde::Deserialize<'de> for ChainPoint {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct utxorpc.build.v1.ChainPoint")
            }
        ...
        deserializer.deserialize_struct("utxorpc.build.v1.ChainPoint", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GetChainParamRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("utxorpc.build.v1.GetChainParamRequest", len)?;
        if !self.param.is_empty() {
...
impl<'de> serde::Deserialize<'de> for GetChainParamRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct utxorpc.build.v1.GetChainParamRequest")
            }
        ...
        deserializer.deserialize_struct("utxorpc.build.v1.GetChainParamRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GetChainParamResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("utxorpc.build.v1.GetChainParamResponse", len)?;
        if !self.param.is_empty() {
            struct_ser.serialize_field("param", &self.param)?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for GetChainParamResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct utxorpc.build.v1.GetChainParamResponse")
            }
        ...
        deserializer.deserialize_struct("utxorpc.build.v1.GetChainParamResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GetChainTipRequest {
        ...
        S: serde::Serializer,
    {
        use serde::ser::SerializeStruct;
        let len = 0;
        let struct_ser = serializer.serialize_struct("utxorpc.build.v1.GetChainTipRequest", len)?;
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for GetChainTipRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct utxorpc.build.v1.GetChainTipRequest")
            }
        ...
        deserializer.deserialize_struct("utxorpc.build.v1.GetChainTipRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GetChainTipResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("utxorpc.build.v1.GetChainTipResponse", len)?;
...
impl<'de> serde::Deserialize<'de> for GetChainTipResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct utxorpc.build.v1.GetChainTipResponse")
            }
        ...
        deserializer.deserialize_struct("utxorpc.build.v1.GetChainTipResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GetUtxoByAddressRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("utxorpc.build.v1.GetUtxoByAddressRequest", len)?;
        if !self.address.is_empty() {
...
impl<'de> serde::Deserialize<'de> for GetUtxoByAddressRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct utxorpc.build.v1.GetUtxoByAddressRequest")
            }
        ...
        deserializer.deserialize_struct("utxorpc.build.v1.GetUtxoByAddressRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GetUtxoByAddressResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("utxorpc.build.v1.GetUtxoByAddressResponse", len)?;
        if !self.items.is_empty() {
...
impl<'de> serde::Deserialize<'de> for GetUtxoByAddressResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct utxorpc.build.v1.GetUtxoByAddressResponse")
            }
        ...
        deserializer.deserialize_struct("utxorpc.build.v1.GetUtxoByAddressResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GetUtxoByRefRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("utxorpc.build.v1.GetUtxoByRefRequest", len)?;
        if !self.r#ref.is_empty() {
...
impl<'de> serde::Deserialize<'de> for GetUtxoByRefRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct utxorpc.build.v1.GetUtxoByRefRequest")
            }
        ...
        deserializer.deserialize_struct("utxorpc.build.v1.GetUtxoByRefRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GetUtxoByRefResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("utxorpc.build.v1.GetUtxoByRefResponse", len)?;
        if !self.items.is_empty() {
            struct_ser.serialize_field("items", &self.items)?;
        }
        if !self.next_token.is_empty() {
...
impl<'de> serde::Deserialize<'de> for GetUtxoByRefResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct utxorpc.build.v1.GetUtxoByRefResponse")
            }
        ...
        deserializer.deserialize_struct("utxorpc.build.v1.GetUtxoByRefResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for HoldUtxoRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("utxorpc.build.v1.HoldUtxoRequest", len)?;
        if !self.refs.is_empty() {
...
impl<'de> serde::Deserialize<'de> for HoldUtxoRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct utxorpc.build.v1.HoldUtxoRequest")
            }
        ...
        deserializer.deserialize_struct("utxorpc.build.v1.HoldUtxoRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for HoldUtxoResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("utxorpc.build.v1.HoldUtxoResponse", len)?;
        if !self.lost.is_empty() {
...
impl<'de> serde::Deserialize<'de> for HoldUtxoResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct utxorpc.build.v1.HoldUtxoResponse")
            }
        ...
        deserializer.deserialize_struct("utxorpc.build.v1.HoldUtxoResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for UtxoRef {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("utxorpc.build.v1.UtxoRef", len)?;
        if !self.hash.is_empty() {
            struct_ser.serialize_field("hash", pbjson::private::base64::encode(&self.hash).as_str())?;
        }
        if self.index != 0 {
...
impl<'de> serde::Deserialize<'de> for UtxoRef {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct utxorpc.build.v1.UtxoRef")
            }
        ...
        deserializer.deserialize_struct("utxorpc.build.v1.UtxoRef", FIELDS, GeneratedVisitor)
    }
}
