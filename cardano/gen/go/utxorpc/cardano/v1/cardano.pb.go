...
func (MirSource) Descriptor() protoreflect.EnumDescriptor {
	return file_utxorpc_cardano_v1_cardano_proto_enumTypes[1].Descriptor()
}

func (MirSource) Type() protoreflect.EnumType {
	return &file_utxorpc_cardano_v1_cardano_proto_enumTypes[1]
}
...
type Redeemer struct {
	...
	Purpose RedeemerPurpose `protobuf:"varint,1,opt,name=purpose,proto3,enum=utxorpc.cardano.v1.RedeemerPurpose" json:"purpose,omitempty"` // Purpose of the redeemer.
...
type Tx struct {
	...
	Hash            []byte         `protobuf:"bytes,1,opt,name=hash,proto3" json:"hash,omitempty"`                                              // Hash of the transaction
	Inputs          []*TxInput     `protobuf:"bytes,2,rep,name=inputs,proto3" json:"inputs,omitempty"`                                          // List of transaction inputs
	Outputs         []*TxOutput    `protobuf:"bytes,3,rep,name=outputs,proto3" json:"outputs,omitempty"`                                        // List of transaction outputs
	Certificates    []*Certificate `protobuf:"bytes,4,rep,name=certificates,proto3" json:"certificates,omitempty"`                              // List of certificates
	Withdrawals     []*Withdrawal  `protobuf:"bytes,5,rep,name=withdrawals,proto3" json:"withdrawals,omitempty"`                                // List of withdrawals
	Mint            []*Multiasset  `protobuf:"bytes,6,rep,name=mint,proto3" json:"mint,omitempty"`                                              // List of minted custom assets
	ReferenceInputs []*TxInput     `protobuf:"bytes,7,rep,name=reference_inputs,json=referenceInputs,proto3" json:"reference_inputs,omitempty"` // List of reference inputs
	Witnesses       *WitnessSet    `protobuf:"bytes,8,opt,name=witnesses,proto3" json:"witnesses,omitempty"`                                    // Witnesses that validte the transaction
	Collateral      *Collateral    `protobuf:"bytes,9,opt,name=collateral,proto3" json:"collateral,omitempty"`                                  // Collateral details in case of failed transaction
	Fee             uint64         `protobuf:"varint,10,opt,name=fee,proto3" json:"fee,omitempty"`                                              // Transaction fee in ADA
	Validity        *TxValidity    `protobuf:"bytes,11,opt,name=validity,proto3" json:"validity,omitempty"`                                     // Validity interval of the transaction
	Successful      bool           `protobuf:"varint,12,opt,name=successful,proto3" json:"successful,omitempty"`                                // Flag indicating whether the transaction was successful
	Auxiliary       *AuxData       `protobuf:"bytes,13,opt,name=auxiliary,proto3" json:"auxiliary,omitempty"`                                   // Auxiliary data not directly tied to the validation process
}
...
func (x *GenesisKeyDelegationCert) Reset() {
	*x = GenesisKeyDelegationCert{}
	if protoimpl.UnsafeEnabled {
		mi := &file_utxorpc_cardano_v1_cardano_proto_msgTypes[38]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GenesisKeyDelegationCert) Descriptor() ([]byte, []int) {
	return file_utxorpc_cardano_v1_cardano_proto_rawDescGZIP(), []int{38}
}
...
func (x *MirTarget) Reset() {
	*x = MirTarget{}
	if protoimpl.UnsafeEnabled {
		mi := &file_utxorpc_cardano_v1_cardano_proto_msgTypes[39]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MirTarget) Descriptor() ([]byte, []int) {
	return file_utxorpc_cardano_v1_cardano_proto_rawDescGZIP(), []int{39}
}
...
type MirCert struct {
	...
	From     MirSource    `protobuf:"varint,1,opt,name=from,proto3,enum=utxorpc.cardano.v1.MirSource" json:"from,omitempty"`
...
func (x *MirCert) Reset() {
	*x = MirCert{}
	if protoimpl.UnsafeEnabled {
		mi := &file_utxorpc_cardano_v1_cardano_proto_msgTypes[40]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MirCert) Descriptor() ([]byte, []int) {
	return file_utxorpc_cardano_v1_cardano_proto_rawDescGZIP(), []int{40}
}
...
func (x *AddressPattern) Reset() {
	*x = AddressPattern{}
	if protoimpl.UnsafeEnabled {
		mi := &file_utxorpc_cardano_v1_cardano_proto_msgTypes[41]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AddressPattern) Descriptor() ([]byte, []int) {
	return file_utxorpc_cardano_v1_cardano_proto_rawDescGZIP(), []int{41}
}
...
func (x *AssetPattern) Reset() {
	*x = AssetPattern{}
	if protoimpl.UnsafeEnabled {
		mi := &file_utxorpc_cardano_v1_cardano_proto_msgTypes[42]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AssetPattern) Descriptor() ([]byte, []int) {
	return file_utxorpc_cardano_v1_cardano_proto_rawDescGZIP(), []int{42}
}
...
func (x *OutputPattern) Reset() {
	*x = OutputPattern{}
	if protoimpl.UnsafeEnabled {
		mi := &file_utxorpc_cardano_v1_cardano_proto_msgTypes[43]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*OutputPattern) Descriptor() ([]byte, []int) {
	return file_utxorpc_cardano_v1_cardano_proto_rawDescGZIP(), []int{43}
}
...
func (x *DatumPattern) Reset() {
	*x = DatumPattern{}
	if protoimpl.UnsafeEnabled {
		mi := &file_utxorpc_cardano_v1_cardano_proto_msgTypes[44]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DatumPattern) Descriptor() ([]byte, []int) {
	return file_utxorpc_cardano_v1_cardano_proto_rawDescGZIP(), []int{44}
}
...
func (x *TxPattern) Reset() {
	*x = TxPattern{}
	if protoimpl.UnsafeEnabled {
		mi := &file_utxorpc_cardano_v1_cardano_proto_msgTypes[45]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*TxPattern) Descriptor() ([]byte, []int) {
	return file_utxorpc_cardano_v1_cardano_proto_rawDescGZIP(), []int{45}
}
...
var file_utxorpc_cardano_v1_cardano_proto_rawDesc = []byte{
	...
	0x61, 0x6e, 0x6f, 0x2e, 0x76, 0x31, 0x22, 0x7f, 0x0a, 0x08, 0x52, 0x65, 0x64, 0x65, 0x65, 0x6d,
	0x65, 0x72, 0x12, 0x3d, 0x0a, 0x07, 0x70, 0x75, 0x72, 0x70, 0x6f, 0x73, 0x65, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x0e, 0x32, 0x23, 0x2e, 0x75, 0x74, 0x78, 0x6f, 0x72, 0x70, 0x63, 0x2e, 0x63, 0x61,
	0x72, 0x64, 0x61, 0x6e, 0x6f, 0x2e, 0x76, 0x31, 0x2e, 0x52, 0x65, 0x64, 0x65, 0x65, 0x6d, 0x65,
	...
	0x28, 0x0b, 0x32, 0x1c, 0x2e, 0x75, 0x74, 0x78, 0x6f, 0x72, 0x70, 0x63, 0x2e, 0x63, 0x61, 0x72,
	0x64, 0x61, 0x6e, 0x6f, 0x2e, 0x76, 0x31, 0x2e, 0x54, 0x78, 0x4f, 0x75, 0x74, 0x70, 0x75, 0x74,
	...
	0x31, 0x2e, 0x52, 0x65, 0x64, 0x65, 0x65, 0x6d, 0x65, 0x72, 0x52, 0x08, 0x72, 0x65, 0x64, 0x65,
	...
	0x74, 0x78, 0x6f, 0x72, 0x70, 0x63, 0x2e, 0x63, 0x61, 0x72, 0x64, 0x61, 0x6e, 0x6f, 0x2e, 0x76,
	0x31, 0x2e, 0x53, 0x63, 0x72, 0x69, 0x70, 0x74, 0x52, 0x06, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74,
	...
	0x2e, 0x63, 0x61, 0x72, 0x64, 0x61, 0x6e, 0x6f, 0x2e, 0x76, 0x31, 0x2e, 0x41, 0x73, 0x73, 0x65,
	...
	0x64, 0x61, 0x6e, 0x6f, 0x2e, 0x76, 0x31, 0x2e, 0x54, 0x78, 0x49, 0x6e, 0x70, 0x75, 0x74, 0x52,
	...
	0x2e, 0x76, 0x31, 0x2e, 0x56, 0x4b, 0x65, 0x79, 0x57, 0x69, 0x74, 0x6e, 0x65, 0x73, 0x73, 0x52,
	...
	0x28, 0x0b, 0x32, 0x1c, 0x2e, 0x75, 0x74, 0x78, 0x6f, 0x72, 0x70, 0x63, 0x2e, 0x63, 0x61, 0x72,
	0x64, 0x61, 0x6e, 0x6f, 0x2e, 0x76, 0x31, 0x2e, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61,
	...
	0x22, 0xaf, 0x05, 0x0a, 0x02, 0x54, 0x78, 0x12, 0x12, 0x0a, 0x04, 0x68, 0x61, 0x73, 0x68, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x04, 0x68, 0x61, 0x73, 0x68, 0x12, 0x33, 0x0a, 0x06, 0x69,
	0x6e, 0x70, 0x75, 0x74, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1b, 0x2e, 0x75, 0x74,
	0x78, 0x6f, 0x72, 0x70, 0x63, 0x2e, 0x63, 0x61, 0x72, 0x64, 0x61, 0x6e, 0x6f, 0x2e, 0x76, 0x31,
	...
	0x69, 0x66, 0x69, 0x63, 0x61, 0x74, 0x65, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1f,
	0x2e, 0x75, 0x74, 0x78, 0x6f, 0x72, 0x70, 0x63, 0x2e, 0x63, 0x61, 0x72, 0x64, 0x61, 0x6e, 0x6f,
	...
	0x32, 0x0a, 0x04, 0x6d, 0x69, 0x6e, 0x74, 0x18, 0x06, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1e, 0x2e,
	...
	0x5f, 0x69, 0x6e, 0x70, 0x75, 0x74, 0x73, 0x18, 0x07, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1b, 0x2e,
	0x75, 0x74, 0x78, 0x6f, 0x72, 0x70, 0x63, 0x2e, 0x63, 0x61, 0x72, 0x64, 0x61, 0x6e, 0x6f, 0x2e,
	...
	0x69, 0x74, 0x6e, 0x65, 0x73, 0x73, 0x65, 0x73, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1e,
	0x2e, 0x75, 0x74, 0x78, 0x6f, 0x72, 0x70, 0x63, 0x2e, 0x63, 0x61, 0x72, 0x64, 0x61, 0x6e, 0x6f,
	...
	0x6c, 0x61, 0x74, 0x65, 0x72, 0x61, 0x6c, 0x18, 0x09, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1e, 0x2e,
	0x75, 0x74, 0x78, 0x6f, 0x72, 0x70, 0x63, 0x2e, 0x63, 0x61, 0x72, 0x64, 0x61, 0x6e, 0x6f, 0x2e,
	...
	0x18, 0x0a, 0x20, 0x01, 0x28, 0x04, 0x52, 0x03, 0x66, 0x65, 0x65, 0x12, 0x3a, 0x0a, 0x08, 0x76,
	0x61, 0x6c, 0x69, 0x64, 0x69, 0x74, 0x79, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1e, 0x2e,
	0x75, 0x74, 0x78, 0x6f, 0x72, 0x70, 0x63, 0x2e, 0x63, 0x61, 0x72, 0x64, 0x61, 0x6e, 0x6f, 0x2e,
	...
	0x73, 0x73, 0x66, 0x75, 0x6c, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0a, 0x73, 0x75, 0x63,
	0x63, 0x65, 0x73, 0x73, 0x66, 0x75, 0x6c, 0x12, 0x39, 0x0a, 0x09, 0x61, 0x75, 0x78, 0x69, 0x6c,
	0x69, 0x61, 0x72, 0x79, 0x18, 0x0d, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1b, 0x2e, 0x75, 0x74, 0x78,
	...
	0x72, 0x79, 0x22, 0x4d, 0x0a, 0x0b, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x48, 0x65, 0x61, 0x64, 0x65,
	...
	,
	...
	0x0c, 0x52, 0x09, 0x73, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x22, 0xf1, 0x02, 0x0a,
	...
	0x62, 0x6b, 0x65, 0x79, 0x12, 0x45, 0x0a, 0x0a, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x5f, 0x61,
	0x6c, 0x6c, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x24, 0x2e, 0x75, 0x74, 0x78, 0x6f, 0x72,
	...
	0x52, 0x09, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x41, 0x6c, 0x6c, 0x12, 0x45, 0x0a, 0x0a, 0x73,
	0x63, 0x72, 0x69, 0x70, 0x74, 0x5f, 0x61, 0x6e, 0x79, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32,
	0x24, 0x2e, 0x75, 0x74, 0x78, 0x6f, 0x72, 0x70, 0x63, 0x2e, 0x63, 0x61, 0x72, 0x64, 0x61, 0x6e,
	...
	0x6e, 0x79, 0x12, 0x43, 0x0a, 0x0d, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x5f, 0x6e, 0x5f, 0x6f,
	0x66, 0x5f, 0x6b, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1e, 0x2e, 0x75, 0x74, 0x78, 0x6f,
	...
	,
	...
	0x69, 0x67, 0x5f, 0x69, 0x6e, 0x74, 0x22, 0x78, 0x0a, 0x0e, 0x50, 0x6c, 0x75, 0x74, 0x75, 0x73,
	...
	0x22, 0xa3, 0x02, 0x0a, 0x0a, 0x50, 0x6c, 0x75, 0x74, 0x75, 0x73, 0x44, 0x61, 0x74, 0x61, 0x12,
	...
	,
	...
	,
	...
	0x61, 0x72, 0x72, 0x61, 0x79, 0x12, 0x34, 0x0a, 0x03, 0x6d, 0x61, 0x70, 0x18, 0x05, 0x20, 0x01,
	...
	0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x75, 0x6d, 0x22, 0x45, 0x0a, 0x0e, 0x4d, 0x65, 0x74, 0x61,
	0x64, 0x61, 0x74, 0x75, 0x6d, 0x41, 0x72, 0x72, 0x61, 0x79, 0x12, 0x33, 0x0a, 0x05, 0x69, 0x74,
	0x65, 0x6d, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1d, 0x2e, 0x75, 0x74, 0x78, 0x6f,
	...
	,
	...
	0x22, 0xee, 0x04, 0x0a, 0x0b, 0x43, 0x65, 0x72, 0x74, 0x69, 0x66, 0x69, 0x63, 0x61, 0x74, 0x65,
	...
	0x6c, 0x65, 0x67, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x38, 0x0a, 0x08, 0x6d, 0x69, 0x72, 0x5f,
	0x63, 0x65, 0x72, 0x74, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1b, 0x2e, 0x75, 0x74, 0x78,
	0x6f, 0x72, 0x70, 0x63, 0x2e, 0x63, 0x61, 0x72, 0x64, 0x61, 0x6e, 0x6f, 0x2e, 0x76, 0x31, 0x2e,
	0x4d, 0x69, 0x72, 0x43, 0x65, 0x72, 0x74, 0x48, 0x00, 0x52, 0x07, 0x6d, 0x69, 0x72, 0x43, 0x65,
	...
	0x0b, 0x70, 0x6f, 0x6f, 0x6c, 0x4b, 0x65, 0x79, 0x68, 0x61, 0x73, 0x68, 0x22, 0xfd, 0x02, 0x0a,
	...
	0x73, 0x74, 0x18, 0x04, 0x20, 0x01, 0x28, 0x04, 0x52, 0x04, 0x63, 0x6f, 0x73, 0x74, 0x12, 0x3a,
	0x0a, 0x06, 0x6d, 0x61, 0x72, 0x67, 0x69, 0x6e, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x22,
	0x2e, 0x75, 0x74, 0x78, 0x6f, 0x72, 0x70, 0x63, 0x2e, 0x63, 0x61, 0x72, 0x64, 0x61, 0x6e, 0x6f,
	0x2e, 0x76, 0x31, 0x2e, 0x52, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x61, 0x6c, 0x4e, 0x75, 0x6d, 0x62,
	0x65, 0x72, 0x52, 0x06, 0x6d, 0x61, 0x72, 0x67, 0x69, 0x6e, 0x12, 0x25, 0x0a, 0x0e, 0x72, 0x65,
	...
	,
	...
	,
	...
	,
	...
	0x41, 0x53, 0x55, 0x52, 0x59, 0x10, 0x02, 0x42, 0xd5, 0x01, 0x0a, 0x16, 0x63, 0x6f, 0x6d, 0x2e,
	0x75, 0x74, 0x78, 0x6f, 0x72, 0x70, 0x63, 0x2e, 0x63, 0x61, 0x72, 0x64, 0x61, 0x6e, 0x6f, 0x2e,
	0x76, 0x31, 0x42, 0x0c, 0x43, 0x61, 0x72, 0x64, 0x61, 0x6e, 0x6f, 0x50, 0x72, 0x6f, 0x74, 0x6f,
	0x50, 0x01, 0x5a, 0x43, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x75,
	0x74, 0x78, 0x6f, 0x72, 0x70, 0x63, 0x2f, 0x73, 0x70, 0x65, 0x63, 0x2f, 0x63, 0x61, 0x72, 0x64,
	0x61, 0x6e, 0x6f, 0x2f, 0x67, 0x65, 0x6e, 0x2f, 0x67, 0x6f, 0x2f, 0x75, 0x74, 0x78, 0x6f, 0x72,
	...
	0x70, 0x63, 0x3a, 0x3a, 0x43, 0x61, 0x72, 0x64, 0x61, 0x6e, 0x6f, 0x3a, 0x3a, 0x56, 0x31, 0x62,
...
var file_utxorpc_cardano_v1_cardano_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_utxorpc_cardano_v1_cardano_proto_msgTypes = make([]protoimpl.MessageInfo, 46)
var file_utxorpc_cardano_v1_cardano_proto_goTypes = []interface{}{
	(RedeemerPurpose)(0),             // 0: utxorpc.cardano.v1.RedeemerPurpose
	(MirSource)(0),                   // 1: utxorpc.cardano.v1.MirSource
	(*Redeemer)(nil),                 // 2: utxorpc.cardano.v1.Redeemer
	(*TxInput)(nil),                  // 3: utxorpc.cardano.v1.TxInput
	(*TxOutput)(nil),                 // 4: utxorpc.cardano.v1.TxOutput
	(*Asset)(nil),                    // 5: utxorpc.cardano.v1.Asset
	(*Multiasset)(nil),               // 6: utxorpc.cardano.v1.Multiasset
	(*TxValidity)(nil),               // 7: utxorpc.cardano.v1.TxValidity
	(*Collateral)(nil),               // 8: utxorpc.cardano.v1.Collateral
	(*Withdrawal)(nil),               // 9: utxorpc.cardano.v1.Withdrawal
	(*WitnessSet)(nil),               // 10: utxorpc.cardano.v1.WitnessSet
	(*AuxData)(nil),                  // 11: utxorpc.cardano.v1.AuxData
	(*Tx)(nil),                       // 12: utxorpc.cardano.v1.Tx
	(*BlockHeader)(nil),              // 13: utxorpc.cardano.v1.BlockHeader
	(*BlockBody)(nil),                // 14: utxorpc.cardano.v1.BlockBody
	(*Block)(nil),                    // 15: utxorpc.cardano.v1.Block
	(*VKeyWitness)(nil),              // 16: utxorpc.cardano.v1.VKeyWitness
	(*NativeScript)(nil),             // 17: utxorpc.cardano.v1.NativeScript
	(*NativeScriptList)(nil),         // 18: utxorpc.cardano.v1.NativeScriptList
	(*ScriptNOfK)(nil),               // 19: utxorpc.cardano.v1.ScriptNOfK
	(*Constr)(nil),                   // 20: utxorpc.cardano.v1.Constr
	(*BigInt)(nil),                   // 21: utxorpc.cardano.v1.BigInt
	(*PlutusDataPair)(nil),           // 22: utxorpc.cardano.v1.PlutusDataPair
	(*PlutusData)(nil),               // 23: utxorpc.cardano.v1.PlutusData
	(*PlutusDataMap)(nil),            // 24: utxorpc.cardano.v1.PlutusDataMap
	(*PlutusDataArray)(nil),          // 25: utxorpc.cardano.v1.PlutusDataArray
	(*Script)(nil),                   // 26: utxorpc.cardano.v1.Script
	(*Metadatum)(nil),                // 27: utxorpc.cardano.v1.Metadatum
	(*MetadatumArray)(nil),           // 28: utxorpc.cardano.v1.MetadatumArray
	(*MetadatumMap)(nil),             // 29: utxorpc.cardano.v1.MetadatumMap
	(*MetadatumPair)(nil),            // 30: utxorpc.cardano.v1.MetadatumPair
	(*Metadata)(nil),                 // 31: utxorpc.cardano.v1.Metadata
	(*StakeCredential)(nil),          // 32: utxorpc.cardano.v1.StakeCredential
	(*RationalNumber)(nil),           // 33: utxorpc.cardano.v1.RationalNumber
	(*Relay)(nil),                    // 34: utxorpc.cardano.v1.Relay
	(*PoolMetadata)(nil),             // 35: utxorpc.cardano.v1.PoolMetadata
	(*Certificate)(nil),              // 36: utxorpc.cardano.v1.Certificate
	(*StakeDelegationCert)(nil),      // 37: utxorpc.cardano.v1.StakeDelegationCert
	(*PoolRegistrationCert)(nil),     // 38: utxorpc.cardano.v1.PoolRegistrationCert
	(*PoolRetirementCert)(nil),       // 39: utxorpc.cardano.v1.PoolRetirementCert
	(*GenesisKeyDelegationCert)(nil), // 40: utxorpc.cardano.v1.GenesisKeyDelegationCert
	(*MirTarget)(nil),                // 41: utxorpc.cardano.v1.MirTarget
	(*MirCert)(nil),                  // 42: utxorpc.cardano.v1.MirCert
	(*AddressPattern)(nil),           // 43: utxorpc.cardano.v1.AddressPattern
	(*AssetPattern)(nil),             // 44: utxorpc.cardano.v1.AssetPattern
	(*OutputPattern)(nil),            // 45: utxorpc.cardano.v1.OutputPattern
	(*DatumPattern)(nil),             // 46: utxorpc.cardano.v1.DatumPattern
	(*TxPattern)(nil),                // 47: utxorpc.cardano.v1.TxPattern
}
var file_utxorpc_cardano_v1_cardano_proto_depIdxs = []int32{
	0,  // 0: utxorpc.cardano.v1.Redeemer.purpose:type_name -> utxorpc.cardano.v1.RedeemerPurpose
	23, // 1: utxorpc.cardano.v1.Redeemer.datum:type_name -> utxorpc.cardano.v1.PlutusData
	4,  // 2: utxorpc.cardano.v1.TxInput.as_output:type_name -> utxorpc.cardano.v1.TxOutput
	2,  // 3: utxorpc.cardano.v1.TxInput.redeemer:type_name -> utxorpc.cardano.v1.Redeemer
	6,  // 4: utxorpc.cardano.v1.TxOutput.assets:type_name -> utxorpc.cardano.v1.Multiasset
	23, // 5: utxorpc.cardano.v1.TxOutput.datum:type_name -> utxorpc.cardano.v1.PlutusData
	26, // 6: utxorpc.cardano.v1.TxOutput.script:type_name -> utxorpc.cardano.v1.Script
	5,  // 7: utxorpc.cardano.v1.Multiasset.assets:type_name -> utxorpc.cardano.v1.Asset
	3,  // 8: utxorpc.cardano.v1.Collateral.collateral:type_name -> utxorpc.cardano.v1.TxInput
	4,  // 9: utxorpc.cardano.v1.Collateral.collateral_return:type_name -> utxorpc.cardano.v1.TxOutput
	16, // 10: utxorpc.cardano.v1.WitnessSet.vkeywitness:type_name -> utxorpc.cardano.v1.VKeyWitness
	26, // 11: utxorpc.cardano.v1.WitnessSet.script:type_name -> utxorpc.cardano.v1.Script
	23, // 12: utxorpc.cardano.v1.WitnessSet.plutus_datums:type_name -> utxorpc.cardano.v1.PlutusData
	31, // 13: utxorpc.cardano.v1.AuxData.metadata:type_name -> utxorpc.cardano.v1.Metadata
	26, // 14: utxorpc.cardano.v1.AuxData.scripts:type_name -> utxorpc.cardano.v1.Script
	3,  // 15: utxorpc.cardano.v1.Tx.inputs:type_name -> utxorpc.cardano.v1.TxInput
	4,  // 16: utxorpc.cardano.v1.Tx.outputs:type_name -> utxorpc.cardano.v1.TxOutput
	36, // 17: utxorpc.cardano.v1.Tx.certificates:type_name -> utxorpc.cardano.v1.Certificate
	9,  // 18: utxorpc.cardano.v1.Tx.withdrawals:type_name -> utxorpc.cardano.v1.Withdrawal
	6,  // 19: utxorpc.cardano.v1.Tx.mint:type_name -> utxorpc.cardano.v1.Multiasset
	3,  // 20: utxorpc.cardano.v1.Tx.reference_inputs:type_name -> utxorpc.cardano.v1.TxInput
	10, // 21: utxorpc.cardano.v1.Tx.witnesses:type_name -> utxorpc.cardano.v1.WitnessSet
	8,  // 22: utxorpc.cardano.v1.Tx.collateral:type_name -> utxorpc.cardano.v1.Collateral
	7,  // 23: utxorpc.cardano.v1.Tx.validity:type_name -> utxorpc.cardano.v1.TxValidity
	11, // 24: utxorpc.cardano.v1.Tx.auxiliary:type_name -> utxorpc.cardano.v1.AuxData
	12, // 25: utxorpc.cardano.v1.BlockBody.tx:type_name -> utxorpc.cardano.v1.Tx
	13, // 26: utxorpc.cardano.v1.Block.header:type_name -> utxorpc.cardano.v1.BlockHeader
	14, // 27: utxorpc.cardano.v1.Block.body:type_name -> utxorpc.cardano.v1.BlockBody
	18, // 28: utxorpc.cardano.v1.NativeScript.script_all:type_name -> utxorpc.cardano.v1.NativeScriptList
	18, // 29: utxorpc.cardano.v1.NativeScript.script_any:type_name -> utxorpc.cardano.v1.NativeScriptList
	19, // 30: utxorpc.cardano.v1.NativeScript.script_n_of_k:type_name -> utxorpc.cardano.v1.ScriptNOfK
	17, // 31: utxorpc.cardano.v1.NativeScriptList.items:type_name -> utxorpc.cardano.v1.NativeScript
	17, // 32: utxorpc.cardano.v1.ScriptNOfK.scripts:type_name -> utxorpc.cardano.v1.NativeScript
	23, // 33: utxorpc.cardano.v1.Constr.fields:type_name -> utxorpc.cardano.v1.PlutusData
	23, // 34: utxorpc.cardano.v1.PlutusDataPair.key:type_name -> utxorpc.cardano.v1.PlutusData
	23, // 35: utxorpc.cardano.v1.PlutusDataPair.value:type_name -> utxorpc.cardano.v1.PlutusData
	20, // 36: utxorpc.cardano.v1.PlutusData.constr:type_name -> utxorpc.cardano.v1.Constr
	24, // 37: utxorpc.cardano.v1.PlutusData.map:type_name -> utxorpc.cardano.v1.PlutusDataMap
	21, // 38: utxorpc.cardano.v1.PlutusData.big_int:type_name -> utxorpc.cardano.v1.BigInt
	25, // 39: utxorpc.cardano.v1.PlutusData.array:type_name -> utxorpc.cardano.v1.PlutusDataArray
	22, // 40: utxorpc.cardano.v1.PlutusDataMap.pairs:type_name -> utxorpc.cardano.v1.PlutusDataPair
	23, // 41: utxorpc.cardano.v1.PlutusDataArray.items:type_name -> utxorpc.cardano.v1.PlutusData
	17, // 42: utxorpc.cardano.v1.Script.native:type_name -> utxorpc.cardano.v1.NativeScript
	28, // 43: utxorpc.cardano.v1.Metadatum.array:type_name -> utxorpc.cardano.v1.MetadatumArray
	29, // 44: utxorpc.cardano.v1.Metadatum.map:type_name -> utxorpc.cardano.v1.MetadatumMap
	27, // 45: utxorpc.cardano.v1.MetadatumArray.items:type_name -> utxorpc.cardano.v1.Metadatum
	30, // 46: utxorpc.cardano.v1.MetadatumMap.pairs:type_name -> utxorpc.cardano.v1.MetadatumPair
	27, // 47: utxorpc.cardano.v1.MetadatumPair.key:type_name -> utxorpc.cardano.v1.Metadatum
	27, // 48: utxorpc.cardano.v1.MetadatumPair.value:type_name -> utxorpc.cardano.v1.Metadatum
	27, // 49: utxorpc.cardano.v1.Metadata.value:type_name -> utxorpc.cardano.v1.Metadatum
	32, // 50: utxorpc.cardano.v1.Certificate.stake_registration:type_name -> utxorpc.cardano.v1.StakeCredential
	32, // 51: utxorpc.cardano.v1.Certificate.stake_deregistration:type_name -> utxorpc.cardano.v1.StakeCredential
	37, // 52: utxorpc.cardano.v1.Certificate.stake_delegation:type_name -> utxorpc.cardano.v1.StakeDelegationCert
	38, // 53: utxorpc.cardano.v1.Certificate.pool_registration:type_name -> utxorpc.cardano.v1.PoolRegistrationCert
	39, // 54: utxorpc.cardano.v1.Certificate.pool_retirement:type_name -> utxorpc.cardano.v1.PoolRetirementCert
	40, // 55: utxorpc.cardano.v1.Certificate.genesis_key_delegation:type_name -> utxorpc.cardano.v1.GenesisKeyDelegationCert
	42, // 56: utxorpc.cardano.v1.Certificate.mir_cert:type_name -> utxorpc.cardano.v1.MirCert
	32, // 57: utxorpc.cardano.v1.StakeDelegationCert.stake_credential:type_name -> utxorpc.cardano.v1.StakeCredential
	33, // 58: utxorpc.cardano.v1.PoolRegistrationCert.margin:type_name -> utxorpc.cardano.v1.RationalNumber
	34, // 59: utxorpc.cardano.v1.PoolRegistrationCert.relays:type_name -> utxorpc.cardano.v1.Relay
	35, // 60: utxorpc.cardano.v1.PoolRegistrationCert.pool_metadata:type_name -> utxorpc.cardano.v1.PoolMetadata
	32, // 61: utxorpc.cardano.v1.MirTarget.stake_credential:type_name -> utxorpc.cardano.v1.StakeCredential
	1,  // 62: utxorpc.cardano.v1.MirCert.from:type_name -> utxorpc.cardano.v1.MirSource
	41, // 63: utxorpc.cardano.v1.MirCert.to:type_name -> utxorpc.cardano.v1.MirTarget
	45, // 64: utxorpc.cardano.v1.TxPattern.any_output:type_name -> utxorpc.cardano.v1.OutputPattern
	43, // 65: utxorpc.cardano.v1.TxPattern.any_address:type_name -> utxorpc.cardano.v1.AddressPattern
	44, // 66: utxorpc.cardano.v1.TxPattern.any_asset:type_name -> utxorpc.cardano.v1.AssetPattern
	46, // 67: utxorpc.cardano.v1.TxPattern.any_datum:type_name -> utxorpc.cardano.v1.DatumPattern
...
func file_utxorpc_cardano_v1_cardano_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_utxorpc_cardano_v1_cardano_proto_msgTypes[38].Exporter = func(v interface{}, i int) interface{} {
		...
		file_utxorpc_cardano_v1_cardano_proto_msgTypes[39].Exporter = func(v interface{}, i int) interface{} {
		...
		file_utxorpc_cardano_v1_cardano_proto_msgTypes[40].Exporter = func(v interface{}, i int) interface{} {
		...
		file_utxorpc_cardano_v1_cardano_proto_msgTypes[41].Exporter = func(v interface{}, i int) interface{} {
		...
		file_utxorpc_cardano_v1_cardano_proto_msgTypes[42].Exporter = func(v interface{}, i int) interface{} {
		...
		file_utxorpc_cardano_v1_cardano_proto_msgTypes[43].Exporter = func(v interface{}, i int) interface{} {
		...
		file_utxorpc_cardano_v1_cardano_proto_msgTypes[44].Exporter = func(v interface{}, i int) interface{} {
		...
		file_utxorpc_cardano_v1_cardano_proto_msgTypes[45].Exporter = func(v interface{}, i int) interface{} {
	...
	file_utxorpc_cardano_v1_cardano_proto_msgTypes[15].OneofWrappers = []interface{}{
	...
	file_utxorpc_cardano_v1_cardano_proto_msgTypes[21].OneofWrappers = []interface{}{
	...
	file_utxorpc_cardano_v1_cardano_proto_msgTypes[24].OneofWrappers = []interface{}{
		(*Script_Native)(nil),
		(*Script_PlutusV1)(nil),
		(*Script_PlutusV2)(nil),
	}
	file_utxorpc_cardano_v1_cardano_proto_msgTypes[25].OneofWrappers = []interface{}{
		(*Metadatum_Int)(nil),
		(*Metadatum_Bytes)(nil),
		(*Metadatum_Text)(nil),
		(*Metadatum_Array)(nil),
	...
	file_utxorpc_cardano_v1_cardano_proto_msgTypes[30].OneofWrappers = []interface{}{
		(*StakeCredential_AddrKeyHash)(nil),
		(*StakeCredential_ScriptHash)(nil),
	}
	file_utxorpc_cardano_v1_cardano_proto_msgTypes[34].OneofWrappers = []interface{}{
	...
	file_utxorpc_cardano_v1_cardano_proto_msgTypes[45].OneofWrappers = []interface{}{
