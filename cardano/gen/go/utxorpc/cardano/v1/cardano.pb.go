...
var file_utxorpc_cardano_v1_cardano_proto_depIdxs = []int32{
	...
	23, // 4: utxorpc.cardano.v1.TxOutput.datum:type_name -> utxorpc.cardano.v1.PlutusData
	26, // 5: utxorpc.cardano.v1.TxOutput.script:type_name -> utxorpc.cardano.v1.Script
